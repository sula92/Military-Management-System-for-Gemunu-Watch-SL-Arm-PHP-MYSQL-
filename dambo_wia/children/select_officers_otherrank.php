...
echo "<center><h2>ALL WIA DEATH AFTER MEDICAL BOARD OUT SOLDIERS $x</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_wia_children WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia_children WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of WIA DEATH AFTER MEDICAL BOARD OUT Children $x is: $inc</h3>"
