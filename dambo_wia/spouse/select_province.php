...
$sql = "SELECT * FROM dambo_wia_spouse WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia_spouse WHERE (Province LIKE '$yr%')";
