...
<body>
<h1 align="center">ALL MIA WHO ARE COMPENSATED IN FULLY &amp; PARTIALLY</h1>
<p align="center">&nbsp;</p>
<?php
...
$sql = "SELECT * FROM `mia_spouse` WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE 'yes%')";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_spouse WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE 'yes%')";
...
echo "<h3>Total Count of Fully or Partially Compensated in MIA SPOUSE is: $inc</h3>"
