...
echo "<center><h2>ALL WIA DEATH AFTER MEDICAL BOARD OUT IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_wia_brosis WHERE (`Date_of_Medical_Board_Out` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia_brosis WHERE (`Date_of_Medical_Board_Out`` LIKE '$yr%')";
...
echo "<h3>Total  Count of WIA DEATH AFTER MEDICAL BOARD OUT BROTHERS & SISTERS In $yr is: $inc</h3>"
