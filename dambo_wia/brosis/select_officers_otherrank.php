...
echo "<center><h2>ALL WIA DEATH AFTER MEDICAL BOARD OUT BROTHERS & SISTERSS $x</center></h2>";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia_brosis WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of WIA DEATH AFTER MEDICAL BOARD OUT  BROTHERS & SISTERS $x is: $inc</h3>"
