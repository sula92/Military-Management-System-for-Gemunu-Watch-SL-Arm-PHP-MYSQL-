...
<body>
<h1 align="center">ALL WIA DEATH AFTER MEDICAL BOARD OUT BROTHERS & SISTERS</h1>
<?php
...
$sql = "SELECT * FROM dambo_wia_brosis ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM dambo_wia_brosis ";
...
?> 
<h3>Total WIA DEATH AFTER MEDICAL BOARD OUT Brothers & Sisters Count is:<?php echo $inc?></h3>
