...
echo "<center><h2>ALL WIA DEATH AFTER MEDICAL BOARD OUT PARENTS IN $uni</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_wia_parents WHERE (`Current/Last_Unit` LIKE '$uni%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia_parents WHERE (`Current/Last_Unit` LIKE '$uni%')";
...
echo "<h3>Total Count of WIA DEATH AFTER MEDICAL BOARD OUT PARENTS From $uni is: $inc</h3>"
?> 
