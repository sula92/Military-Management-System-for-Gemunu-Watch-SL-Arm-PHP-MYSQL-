...
echo "<center><h2>ALL WIA DEATH AFTER MEDICAL BOARD OUT PARENTS $x</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_wia_parents WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia_parents WHERE (Regiment_No LIKE '$yr%')";
