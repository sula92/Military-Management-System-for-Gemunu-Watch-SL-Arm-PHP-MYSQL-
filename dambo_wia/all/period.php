...
<a href="http://localhost/gw/dambo_wia.php"><button class="w3-button w3-round-xxxlarge w3-blue">BACK TO DAMBO-WIA</button></a>
...
<div class="container">
  <h1>ALL DEATH AFTER MEDICAL BOARD OUT WIA LIST(DATE OF MEDICAL BOARD OUT,PERIOD WISE)</h1>
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia WHERE (Date_of_Medical_Board_Out BETWEEN '$sy%' AND '$yr%')";
...
echo "<h3>Total Count of DEATH AFTER MEDICAL BOARD WIA FROM $sy TO $yr is: $inc</h3>";
