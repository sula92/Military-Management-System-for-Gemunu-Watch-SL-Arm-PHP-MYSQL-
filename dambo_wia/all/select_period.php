...
echo "<center><h2>ALL DEATH AFTER MEDICAL BOARD OUT WIA TILL TO $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_wia WHERE (Date_of_Medical_Board_Out BETWEEN '0000-00-00' AND '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia WHERE (Date_of_Medical_Board_Out BETWEEN '0000-00-00' AND '$yr%')";
