...
$sql = "SELECT * FROM dambo_wia WHERE (Date_of_Medical_Board_Out LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_wia WHERE (`Date_of_Medical_Board_Out` LIKE '$yr%')";
...
echo "<h3>Total Count of WIA DEATH AFTER MEDICAL BOARD OUT In $yr is: $inc</h3>"
