...
$sql = "SELECT * FROM dambo_wia_spouse WHERE (NIC_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
<div id="navDemo" class="w3-bar-block w3-panel w3-border-top w3-border-bottom w3-black w3-hide w3-hide-large w3-hide-medium w3-top " style="margin-top:46px">
  ...
  <a href="file:///C|/xampp/htdocs/gw/dambo_wia_children.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CHILDREN</a>
  <a href="#" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">BROTHERS/SISTERS</a>
  <a href="file:///C|/xampp/htdocs/gw/dambo_wia_parents.php class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">PARENTS</a>
</div>
...
<div class="w3-sidebar w3-bar-block w3-dark-grey w3-card w3-animate-right" style="display:none;right:0; width:30%; " id="rightMenu">
 ...
 <center> <a href="alldambo_wia.php" class="w3-bar-item w3-button" style="color:white"><center>ALL dambo_wia</center></a></center>
