...
include('Config.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM mbo_wia_brosis WHERE NIC_No='$_POST[txtidno]'";
	...
	if(isset($_POST['btnSave'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "UPDATE mbo_wia_brosis SET `File_No`='$_POST[txtfino]',`Regiment_No`='$_POST[txtregnum]',`Rank`='$_POST[txtrank]',`Rank_Seniority_Order`='$_POST[rsen]',`Name(Army_Form)`='$_POST[txtnm]',`Full_Name`='$_POST[txtfnm]',`Army_ID_No`='$_POST[txtaid]',`Current/Last_Unit`='$_POST[txtcu]',`Date_of_Medical_Board_Out`='$_POST[doin]',
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_wia_brosis WHERE NIC_No='$_POST[txtidno]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "INSERT INTO dambo_wia_brosis VALUES('$_POST[txtfino]','$_POST[txtregnum]','$_POST[txtrank]','$_POST[rsen]','$_POST[txtnm]','$_POST[txtfnm]','$_POST[txtaid]','$_POST[txtcu]','$_POST[doin]','$_POST[nic]','$_POST[rels]','$_POST[sfnm]','$_POST[nmin]','$_POST[dob]','$_POST[pob]','$_POST[txtbcn]','$_POST[cis]','$_POST[lsta]','$_POST[dode]','$_POST[dcpr]','$_POST[dcno]','$_POST[rel]','$_POST[eth]','$_POST[noch]','$_POST[nobs]','$_POST[lod]','$_POST[bnk]','$_POST[txtbra]','$_POST[accno]','$_POST[txtacn]','$_POST[txthadd]','$_POST[city]','$_POST[dis]','$_POST[pro]','$_POST[dsag]','$_POST[elect]','$_POST[gnd]','$_POST[nac]','$_POST[nps]','$_POST[mob]','$_POST[hpp]','$_POST[altc]','$_POST[txtemai]','$_POST[msal]','$_POST[whom]','$_POST[fwhe]','$_POST[hola]','$_POST[txthladd]','$_POST[abf]','$_POST[mondi]','$_POST[welf]','$_POST[dowp]','$_POST[hadd]','$_POST[comp]','$_POST[compd]','$_POST[amou]','$_POST[lfa]','$_POST[tta]','$_POST[ratp]')";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
//Check the Button
	if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_wia_brosis WHERE NIC_No='$_POST[txtidno]' ||  NIC_No='$_POST[nic]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="mbo_wia_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="mbo_wia/brosis/allmbo_wia_brosis.php" class="w3-bar-item w3-button" style="color:white"><center>ALL WIA MEDICAL BOARD OUT BROTHERS & SISTERS</center></a></center>
 



  <center><a href="mbo_wia/brosis/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="mbo_wia/brosis/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="mbo_wia/brosis/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
  
   <center> <a href="mbo_wia/brosis/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="mbo_wia/brosis/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="mbo_wia/brosis/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div style="margin-left:200px"><button onclick="w3.toggleShow('#qui')">&#9776;</button> </div>
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
     <h1 style="margin-left:18%">WIA MEDICAL BOARD OUT BROTHERS & SISTERS</h1></center>
  </div>
</div>
...
xmlhttp.open("GET","mbo_wia/brosis/select_brosis.php?par="+document.getElementById("myInput").value,false);
xmlhttp.send(null);
