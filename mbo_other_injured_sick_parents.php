...
include('Config.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM mbo_other_injured_sick_parents WHERE NIC_No='$_POST[txtidno]'";
	...
	if(isset($_POST['btnSave'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "UPDATE mbo_other_injured_sick_parents SET `File_No`='$_POST[txtfino]',`Regiment_No`='$_POST[txtregnum]',`Rank`='$_POST[txtrank]',`Rank_Seniority_Order`='$_POST[rsen]',`Name(Army_Form)`='$_POST[txtnm]',`Full_Name`='$_POST[txtfnm]',`Army_ID_No`='$_POST[txtaid]',`Current/Last_Unit`='$_POST[txtcu]',`Date_of_Medical_Board_Out`='$_POST[doin]',
		
		
		`NIC_No`='$_POST[nic]',`Relationship`='$_POST[rels]',`Parent_Full_Name`='$_POST[sfnm]',`Name_With_Initials`='$_POST[nmin]',`Date_of_Birth`='$_POST[dob]',`Place_of_Birth`='$_POST[pob]',`Birth_Certificate_No`='$_POST[txtbcn]',`Life_Status`='$_POST[lsta]',`Date_of_Death`='$_POST[dode]',`Death_Certificate_Provided`='$_POST[dcpr]',`Death_Certificate_Number`='$_POST[dcno]',`Religion`='$_POST[rel]',`Ethnicity`='$_POST[eth]',`Number_of_Children_Have_Got`='$_POST[noch]',`Number_of_Brothers_&_Sisters`='$_POST[nobs]',`List_of_Dependents`='$_POST[lod]',`Bank_Name`='$_POST[bnk]',`Branch`='$_POST[txtbra]',`Account_Number`='$_POST[accno]',`Account_Name`='$_POST[txtacn]',
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick_parents WHERE NIC_No='$_POST[txtidno]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "INSERT INTO dambo_other_injured_sick_parents VALUES('$_POST[txtfino]','$_POST[txtregnum]','$_POST[txtrank]','$_POST[rsen]','$_POST[txtnm]','$_POST[txtfnm]','$_POST[txtaid]','$_POST[txtcu]','$_POST[doin]','$_POST[nic]','$_POST[rels]','$_POST[sfnm]','$_POST[nmin]','$_POST[dob]','$_POST[pob]','$_POST[txtbcn]','$_POST[lsta]','$_POST[dode]','$_POST[dcpr]','$_POST[dcno]','$_POST[rel]','$_POST[eth]','$_POST[noch]','$_POST[nobs]','$_POST[lod]','$_POST[bnk]','$_POST[txtbra]','$_POST[accno]','$_POST[txtacn]','$_POST[txthadd]','$_POST[city]','$_POST[dis]','$_POST[pro]','$_POST[dsag]','$_POST[elect]','$_POST[gnd]','$_POST[nac]','$_POST[nps]','$_POST[mob]','$_POST[hpp]','$_POST[altc]','$_POST[txtemai]','$_POST[msal]','$_POST[whom]','$_POST[fwhe]','$_POST[hola]','$_POST[txthladd]','$_POST[abf]','$_POST[mondi]','$_POST[welf]','$_POST[dowp]','$_POST[hadd]','$_POST[comp]','$_POST[compd]','$_POST[amou]','$_POST[lfa]','$_POST[tta]','$_POST[ratp]')";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
//Check the Button
	if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick_parents WHERE NIC_No='$_POST[txtidno]' ||  NIC_No='$_POST[nic]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="mbo_other_injured_sick_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="mbo_other_injured_sick/parents/allmbo_other_injured_sick_parents.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER INJURED/SICK MEDICAL BOARD OUT PARENTS</center></a></center>
 



  <center><a href="mbo_other_injured_sick/parents/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="mbo_other_injured_sick/parents/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="mbo_other_injured_sick/parents/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
  
   <center> <a href="mbo_other_injured_sick/parents/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="mbo_other_injured_sick/parents/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="mbo_other_injured_sick/parents/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div style="margin-left:200px"><button onclick="w3.toggleShow('#qui')">&#9776;</button> </div>
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
     <h1 style="margin-left:18%">OTHER INJURED/SICK MEDICAL BOARD OUT PARENTS</h1></center>
  </div>
</div>
...
<div class="container" style="opacity:0.85">
 ...
 <form class="" action="#" name="frmStud" method="post" id="mil" enctype="multipart/form-data">
	...
	if(isset($_POST['btnSearch'])){	   
         ...
         echo "<img src = 'parents_photos/$imagedisplay' style=\"float:right; width:210px;\" class=\"pic\"/>";
...
?>         
      ...
      <option value="01">01-FIELD MARSHAL(ෆීල්ඩ් මාර්ෂල්)</option>
          ...
          <div class="row">
            ...
            <div class="row"></div>
    <fieldset><legend style="color:red">PARENT'S PERSONAL DETAILS (දෙමාපිය/හිමිකරු පුද්ගලික විස්තර)</legend>  
           <div class="row">
            <div class="ld">
         ...
         <div class="row">
            	<div class="ld"><label style="color:white">Relationship</label></div>
                <div class="rd">
         <select id="rels" name="rels">
          <option value="<?php echo $rels; ?>"><?php echo $rels; ?></option>         
          <option value="Father(පියා)">Father(පියා)</option>
          <option value="Mother(මව)">Mother(මව)</option>
          <option value="Ownwer(භාරකරු)">Ownwer(භාරකරු)</option>
          <option value="Aunty(නැන්දා)">Aunty(නැන්දා)</option>
          <option value="Uncle(මාමා)">Uncle(මාමා)</option>
          <option value="Brother(සහෝදරයා)">Brother(සහෝදරයා)</option>
          <option value="Sister(සහෝදරිය)">Sister(සහෝදරිය)</option>
          <option value="Cousin(ඥාති සහෝදරයා)">Cousin(ඥාති සහෝදරයා)</option>
          <option value="Father(කලත්රයාගේ පියා)">Spouse_s Father(කලත්රයාගේ පියා)</option>
          <option value="Spouse_s Mother(කලත්රයාගේ මව)">Spouse_s Mother(කලත්රයාගේ මව)</option>
          <option value="Spouse_s Ownwer(කලත්රයාගේ භාරකරු)">Spouse_s Ownwer(කලත්රයාගේ භාරකරු)</option>
          <option value="Spouse_s Aunty(කලත්රයාගේ නැන්දා)">Spouse_s Aunty(කලත්රයාගේ නැන්දා)</option>
          <option value="Spouse_s Uncle(කලත්රයාගේ මාමා)">Spouse_s Uncle(කලත්රයාගේ මාමා)</option>
          <option value="Spouse_s Brother(කලත්රයාගේ සහෝදරයා)">Spouse_s Brother(කලත්රයාගේ සහෝදරයා)</option>
          <option value="Spouse_s Sister(කලත්රයාගේ සහෝදරිය)">Spouse_s Sister(කලත්රයාගේ සහෝදරිය)</option>
          <option value="Spouse_s Cousin(කලත්රයාගේ ඥාති සහෝදරයා)">Spouse_s Cousin(කලත්රයාගේ ඥාති සහෝදරයා)</option>
...
<div class="row">
    ...
    <div class="row">
     ...
     <fieldset><legend style="color:red">IF PARENT IS DEAD(ජීවමාන නොවේ නම්)</legend>       
            <div class="row">
...
xmlhttp.open("GET","mbo_other_injured_sick/parents/select_parent.php?par="+document.getElementById("myInput").value,false);
xmlhttp.send(null);
