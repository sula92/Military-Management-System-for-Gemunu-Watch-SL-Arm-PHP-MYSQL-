...
echo "<center><h2>ALL MIA BROTHERS & SISTERS IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mia_brosis WHERE (Date_of_Incident LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_brosis WHERE (`Date_of_Incident` LIKE '$yr%')";
...
echo "<h3>Total Count of MIA BROTHERS & SISTERS In $yr is: $inc</h3>"
