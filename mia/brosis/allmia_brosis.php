...
<body>
<h1 align="center">ALL MIA BROTHERS & SISTERS</h1>
<?php
...
$sql = "SELECT * FROM mia_brosis ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM mia_brosis ";
...
?> 
<h3>Total MIA Brothers & Sisters Count is:<?php echo $inc?></h3>
