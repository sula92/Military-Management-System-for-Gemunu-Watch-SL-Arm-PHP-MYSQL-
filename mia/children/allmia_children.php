...
<body>
<h1 align="center">ALL MIA CHILDREN</h1>
<?php
...
$sql = "SELECT * FROM mia_children ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM mia_children ";
...
?> 
<h3>Total MIA Children Count is:<?php echo $inc?></h3>
