...
echo "<center><h2>ALL MIA CHILDREN IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mia_children WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_children WHERE (Province LIKE '$yr%')";
...
echo "<h3>Total Count of MIA CHILDREN In $yr is: $inc</h3>"
