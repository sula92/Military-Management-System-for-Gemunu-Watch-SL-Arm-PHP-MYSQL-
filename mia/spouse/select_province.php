...
$sql = "SELECT * FROM mia_spouse WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_spouse WHERE (Province LIKE '$yr%')";
...
echo "<h3>Total Count of MIA SPOUSES In $yr is: $inc</h3>"
