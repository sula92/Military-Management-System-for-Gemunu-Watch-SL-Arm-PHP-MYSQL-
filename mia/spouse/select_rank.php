...
$sql = "SELECT * FROM mia_spouse WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_spouse WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of MIA SPOUSES is: $inc</h3>"
