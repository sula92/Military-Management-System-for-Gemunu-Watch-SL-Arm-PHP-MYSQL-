...
$sql = "SELECT * FROM mia WHERE (Date_of_Incident BETWEEN '0000-00-00' AND '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (Date_of_Incident BETWEEN '0000-00-00' AND '$yr%')";
...
echo "<h3>Total Count of MIA TILL TO $yr is: $inc</h3>"
