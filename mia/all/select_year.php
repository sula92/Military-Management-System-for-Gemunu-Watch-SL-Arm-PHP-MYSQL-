...
$sql = "SELECT * FROM mia WHERE (Date_of_Incident LIKE  '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Date_of_Incident` LIKE '$yr%')";
...
echo "<h3>Total MIA Count of MIA In $yr is: $inc</h3>"
