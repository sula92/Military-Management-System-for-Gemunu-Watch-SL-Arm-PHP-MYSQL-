...
echo "<center><h2>ALL $u MIA</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mia WHERE (Civil_Status LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (Civil_Status LIKE '$yr%')";
...
echo "<h3>TOTAL $u MIA COUNT IS: $inc</h3>"
