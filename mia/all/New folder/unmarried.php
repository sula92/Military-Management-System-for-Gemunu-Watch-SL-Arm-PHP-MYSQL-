...
<body>
<h1 align="center">ALL UNMARRIED MIA</h1>
<?php
...
$sql = "SELECT *  FROM `mia` WHERE (Civil_Status LIKE 'u%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Civil_Status` LIKE 'un%')";
...
echo "<h3>Total UnMarried Count of MIA is: $inc</h3>"
