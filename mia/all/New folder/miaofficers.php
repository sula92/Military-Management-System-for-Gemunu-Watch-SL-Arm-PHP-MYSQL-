...
<body>
<h1 align="center">ALL MIA OFFICERS</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (Regiment_No LIKE 'N%') ORDER BY Rank_Seniority_Order";
...
<h3>Total MIA Officers Count is:<?php echo $inc?></h3>
