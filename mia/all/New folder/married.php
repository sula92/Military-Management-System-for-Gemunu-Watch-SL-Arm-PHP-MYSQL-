...
<body>
<h1 align="center">ALL MARRIED MIA</h1>
<?php
...
$sql = "SELECT *  FROM `mia` WHERE (Civil_Status LIKE 'm%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Civil_Status` LIKE 'm%')";
...
echo "<h3>Total Married Count of MIA is: $inc</h3>"
