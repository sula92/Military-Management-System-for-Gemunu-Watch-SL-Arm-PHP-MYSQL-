...
<body>
<h1 align="center">ALL MIA FROM EASTERN PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'eastern%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'eastern%')";
...
echo "<h3>Total MIA Soldiers from Eastern Province: $inc</h3>"
