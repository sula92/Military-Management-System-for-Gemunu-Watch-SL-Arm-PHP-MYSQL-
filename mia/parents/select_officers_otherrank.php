...
$sql = "SELECT * FROM mia_parents WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_parents WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of MIA $x is: $inc</h3>"
