...
<body>
<h1 align="center">ALL MIA PARENTS</h1>
<?php
...
$sql = "SELECT * FROM mia_parents ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM mia_parents ";
...
?> 
<h3>Total MIA Prents Count is:<?php echo $inc?></h3>
