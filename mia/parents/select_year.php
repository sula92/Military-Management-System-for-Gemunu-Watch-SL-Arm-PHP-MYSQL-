...
$sql = "SELECT * FROM mia_parents WHERE (Date_of_Incident LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_parents WHERE (`Date_of_Incident` LIKE '$yr%')";
...
echo "<h3>Total Count of MIA PARENTS In $yr is: $inc</h3>"
