...
echo "<center><h2>ALL THE $ran of MIA</center></h2>";

mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mia_parents WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_parents WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of MIA PARENTS is: $inc</h3>"
