...
include('session.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM absent WHERE Regiment_No='$_POST[txtregno]'";
	...
	if(isset($_POST['btnSearch'])){
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				...
				$abda=$row['Absent_Date'];
				$abti=$row['Absent_Time'];
	...
	$dbname="rft_gw";
        ...
        if($insert){
           echo '<script language="javascript">';
            ...
            echo '<script language="javascript">';
            echo 'alert("PLEASE SELECT A IMAGE TO UPLOAD")';
            echo '</script>';
    }
}
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM absent WHERE Regiment_No='$_POST[txtregno]' || Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="absent.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left w3-black" style="width:200px; margin-top:-0.4%" id="mySidebar">
  ...
  <a href="#kia" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">ABSENT INFORMATION</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="absent/all/allabsent.php" class="w3-bar-item w3-button" style="color:white"><center>ALL ABSENT</center></a></center>
 


  <center> <a href="absent/all/per.php" class="w3-bar-item w3-button" style="color:white"><center>ALL NEEDED PERSONAL DETAILS OF A SOLDIER</center></a></center>

  <center><a href="absent/all/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="absent/all/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="absent/all/period.php" class="w3-bar-item w3-button" style="color:white"><center>PERIOD WISE</center></a></center>
 
  <center> <a href="absent/all/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
   
  <center> <a href="absent/all/married_unmarried.php" class="w3-bar-item w3-button" style="color:white"><center>MARRIED / UNMARRIED  WISE</center></a></center>
  
   <center> <a href="absent/all/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="absent/all/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="absent/all/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
if(isset($_POST["btnSearch"]))
{
	...
	$id=base_convert($_POST['txtregno'],16,2);
	
	
   $res=mysqli_query($con,"select * from photos WHERE id LIKE {echo $id}");
  
   
   while($row=mysqli_fetch_array($res))
   {
          
          echo '<img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" style="float:right; width:190px;" class="pic"/>';
...
<div class="row" id="kia">
  ...
  <fieldset><legend style="color:red">ABSENT INFORMATION</legend>
  
  <div class="row">
      <div class="col-25">
        <label for="fname" style="color:white">Absent Date (දිනය)</label>
      </div>
      <div class="col-75">
     ...
     <div class="row">
      <div class="col-25">
        <label for="fname" style="color:white">Absent Time (වේලාව)</label>
      </div>
      <div class="col-75">
        <input type="time" id="abti" name="abti"  style="width:100%" value="<?php echo $abti; ?>" />
      </div>
    </div>
...
<fieldset id="kia"><legend style="color:red">CATEGORY INFORMATION (IF HAVE A CATEGORY)</legend>

<div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">MAIN CATEGORY</label>
      </div>
      <div class="col-75">
         <select id="mcat" name="mcat">
         <option><?php echo $mcat; ?></option>
     <option value="WIA">WIA</option>
      <option value="OTHER INJURED SICK(වෙනත් තුවාල/අසනීප ලැබූ)">OTHER INJURED SICK(වෙනත් තුවාල/අසනීප ලැබූ)</option>
    </select>
      </div>
    </div>
...
<div class="row">
 ...
 <div class="row">
     ...
     <option value=""><?php echo $opsar; ?></option>   
    ...
    <div class="row">
     ...
     <option value=""><?php echo $ams; ?></option>   
