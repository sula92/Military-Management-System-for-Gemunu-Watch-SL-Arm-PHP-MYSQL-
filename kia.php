...
include('image.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM kia WHERE Regiment_No='$_POST[txtregno]'";
	...
	if(isset($_POST['btnSave'])){
		...
		`Do_You_Recieve_the_Soldiers_Monthly_Salary`='$_POST[msal]',`By_Whom`='$_POST[whom]',`From_Where`='$_POST[fwhe]',`Have_the_Soldier_Got_Any_Home/Land_From_SL_Army`='$_POST[hola]',`If So_Address_of_the_Home/Land`='$_POST[txthladd]',`Has_the_Soldier_Joined_With_the_ABF_Fund`='$_POST[abf]',`If_So_How_Much_Was_the_Monthly_Deduction`='$_POST[mondi]',`Have_the_Soldier_Joined_the_Welfare_Fund`='$_POST[welf]',`Has_He_Bought_Anything_Under_the_Down_Payment`='$_POST[dowp]',`If So_Please_Provide_the_Details`='$_POST[hadd]',`Has_the_Soldier_Got_Any_Compensation_From_SL_Army`='$_POST[comp]',`If_So_The_Date_that_Soldier_Got_the_Compensation`='$_POST[compd]',`If_So_The_Amount`='$_POST[amou]',`Have_the_Soldier_Got_Any_Loan_From_SL_Army`='$_POST[lfa]',`If_So_The_Total_Amount_of_Loan`='$_POST[tta]',`If_So_The_Remaining _Amount _to_be _Paid`='$_POST[ratp]' 
		 ...
		 WHERE Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM kia WHERE Regiment_No='$_POST[txtregno]' || Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
   ...
   <a href="kia_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
      
       
    
    <a href="kia.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
    <a href="javascript:void(0)" class="w3-padding-large w3-hover-red w3-hide-small w3-right"><i class="fa fa-search"></i></a></div>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="kia/all/allkia.php" class="w3-bar-item w3-button" style="color:white"><center>ALL KIA</center></a></center>
 
 
  <center> <a href="kia/all/per.php" class="w3-bar-item w3-button" style="color:white"><center>ALL NEEDED PERSONAL DETAILS OF A SOLDIER</center></a></center>



  <center><a href="kia/all/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="kia/all/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="kia/all/period.php" class="w3-bar-item w3-button" style="color:white"><center>PERIOD WISE</center></a></center>
 
  <center> <a href="kia/all/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
   
  <center> <a href="kia/all/married_unmarried.php" class="w3-bar-item w3-button" style="color:white"><center>MARRIED / UNMARRIED  WISE</center></a></center>
  
   <center> <a href="kia/all/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="kia/all/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="kia/all/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div class="w3-teal">
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
      <h1>KILLED IN ACTION</h1></center>
  </div>
</div>


<div class="w3-container" style="margin-left:1%">
<div class="container" style="border:2px; opacity:0.85;">
...
<fieldset id="kia"><legend style="color:red">KIA INFORMATION</legend>

<div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Reason For KIA (හේතුව)</label>
      </div>
      <div class="col-75">
...
<div class="row">
      ...
      <div class="col-75">
        <input type="text" id="cno" name="cno" placeholder="මරණ සහතික අංකය.." style="width:100%" value="<?php echo $cno; ?>" />
      </div>
    </div>
