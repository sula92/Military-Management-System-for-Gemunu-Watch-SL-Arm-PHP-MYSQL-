...
<body>
<h1 align="center">ALL OTHER DEATH CHILDREN</h1>
<?php
...
$sql = "SELECT * FROM other_death_children ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM other_death_children ";
...
?> 
<h3>Total OTHER DEATH Children Count is:<?php echo $inc?></h3>
