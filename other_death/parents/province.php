...
<h2>SELECT A PROVINCE</h2>
 <select id="myInput" name="myInput" onChange="myFunction();">
     ...
     <option value="Southern">Southern(දකුණු පළාත)</option>
     <option value="Central">Central(මධ්‍යම පළාත)</option>
     <option value="Northern">Northern(උතුරු පළාත) </option>
     <option value="North Western">North Western(වයඹ)</option>
     <option value="North Central">North Central(උතුරුමැද)</option>
...
xmlhttp.open("GET","select_province.php?yr="+document.getElementById("myInput").value,false);
xmlhttp.send(null);
