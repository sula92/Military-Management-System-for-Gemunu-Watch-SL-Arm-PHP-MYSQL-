...
<body>
<h1 align="center">ALL OTHER DEATH SOLDIER'S PARENTS</h1>
<?php
...
$sql = "SELECT * FROM other_death_parents ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM other_death_parents ";
...
?> 
<h3>Total OTHER DEATH Prents Count is:<?php echo $inc?></h3>
