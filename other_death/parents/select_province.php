...
echo "<center><h2>ALL OTHER DEATH OTHER DEATH PARENTS IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death_parents WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death_parents WHERE (Province LIKE '$yr%')";
...
echo "<h3>Total Count of OTHER DEATH PARENTS In $yr is: $inc</h3>"
