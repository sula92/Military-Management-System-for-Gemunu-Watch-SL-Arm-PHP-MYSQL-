...
<body>
<h1 align="center">ALL OTHER DEATH BROTHERS & SISTERS</h1>
<?php
...
$sql = "SELECT * FROM other_death_brosis ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM other_death_brosis ";
...
?> 
<h3>Total OTHER DEATH Brothers & Sisters Count is:<?php echo $inc?></h3>
