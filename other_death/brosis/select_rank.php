...
$sql = "SELECT * FROM other_death_brosis WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death_brosis WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of OTHER DEATH BROTHERS & SISTERS is: $inc</h3>"
