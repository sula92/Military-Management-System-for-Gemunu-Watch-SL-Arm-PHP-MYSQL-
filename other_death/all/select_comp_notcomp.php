...
echo "<center><h2>ALL OTHER DEATH $x  </center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '%$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '$yr%')";
...
echo "<h3>TOTAL $x OTHER DEATH COUNT IS: $inc</h3>"
