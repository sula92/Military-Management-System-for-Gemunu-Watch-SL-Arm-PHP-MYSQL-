...
<body>
<h1 align="center">ALL MIA FROM NORTH WESTERN PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'north_western%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'north_western%')";
...
echo "<h3>Total MIA Soldiers from Central Province: $inc</h3>"
