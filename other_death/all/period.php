...
<a href="http://localhost/gw/other_death.php"><button class="w3-button w3-round-xxxlarge w3-blue">BACK TO OTHER DEATH</button></a>
...
<div class="container">
  <h1>OTHER DEATH LIST(DATE OF DEATH,PERIOD WISE)</h1>
...
echo "<center><h2>ALL OTHER DEATH FROM $sy TO $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death WHERE (Date_of_Incident BETWEEN '$sy' AND '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death WHERE (Date_of_Incident BETWEEN '$sy' AND '$yr%')";
...
echo "<h3>Total OTHER DEATH Count of OTHER DEATH FROM $sy TO $yr is: $inc</h3>";
