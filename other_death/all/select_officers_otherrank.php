...
$sql = "SELECT * FROM other_death WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of OTHER DEATH $x is: $inc</h3>"
