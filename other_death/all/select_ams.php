...
echo "<center><h2>ALL OTHER DEATH OF $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death WHERE (	`Attributed/Not_Attributed_to_Military_Service` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death WHERE (	`Attributed/Not_Attributed_to_Military_Service` LIKE '$yr%')";
...
echo "<h3>Total OTHER DEATH Count of $yr is: $inc</h3>"
