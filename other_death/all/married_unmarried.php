...
<h2>SELECT SOLDIERS CIVIL STATUS(විවාහ තත්වය)</h2>
 <select id="myInput" name="myInput" onChange="myFunction();">
     ...
     <option value="Married">Married(විවාහක)</option>
      ...
      <option value="Living Together">Living Together(එකට ජීවත් වෙනවා)</</option>
      <option value="Spouse has Dead">Spouse has Dead(කලත්රයා මිය ගොස් ඇත)</option>
...
xmlhttp.open("GET","select_married_unmarried.php?yr="+document.getElementById("myInput").value,false);
xmlhttp.send(null);
