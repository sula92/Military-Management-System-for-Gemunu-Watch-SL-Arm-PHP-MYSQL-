...
$sql = "SELECT * FROM other_death WHERE (	`Operational/Non_Operational_Areas` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death WHERE (	`Operational/Non_Operational_Areas` LIKE '$yr%')";
...
echo "<h3>Total OTHER DEATH Count of $yr is: $counter</h3>"
