...
echo "<center><h2>ALL OTHER DEATH TILL TO $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death WHERE (Date_of_Incident BETWEEN '0000-00-00' AND '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death WHERE (Date_of_Incident BETWEEN '0000-00-00' AND '$yr%')";
...
echo "<h3>Total MIA Count of OTHER DEATH TILL TO $yr is: $inc</h3>"
