...
$sql = "SELECT * FROM other_death WHERE Regiment_No='$reg'";
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://localhost/gw/other_death_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BROTHERS/SISTERS</a>
      ...
      <a href="http://localhost/gw/other_death_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
      
       
    
    <a href="http://localhost/gw/other_death.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="allother_death.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER DEATH</center></a></center>
  ...
  <center><a href="ams.php" class="w3-bar-item w3-button" style="color:white"><center>AMS/ NOT AMS</center></a>
