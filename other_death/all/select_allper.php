...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <link rel="stylesheet" href="http://localhost/gw/w3.css">
...
$sql = "SELECT * FROM other_death WHERE (Regiment_No LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death_spouse WHERE (Regiment_No LIKE '$ran%') ORDER BY Rank_Seniority_Order";
$result = $conn->query($sql);
...
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death_children WHERE (Regiment_No LIKE '$ran%') ORDER BY Rank_Seniority_Order";
$result = $conn->query($sql);
...
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death_parents WHERE (Regiment_No LIKE '$ran%') ORDER BY Rank_Seniority_Order";
$result = $conn->query($sql);
...
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_death_brosis WHERE (Regiment_No LIKE '$ran%') ORDER BY Rank_Seniority_Order";
$result = $conn->query($sql);
