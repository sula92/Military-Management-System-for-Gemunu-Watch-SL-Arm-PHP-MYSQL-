...
$sql = "SELECT * FROM other_death WHERE (Date_of_Incident LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death WHERE (`Date_of_Incident` LIKE '$yr%')";
...
echo "<h3>Total Count of OTHER DEATH In $yr is: $inc</h3>"
