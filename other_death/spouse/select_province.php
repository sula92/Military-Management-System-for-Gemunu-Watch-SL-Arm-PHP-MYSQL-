...
$sql = "SELECT * FROM other_death_spouse WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_death_spouse WHERE (Province LIKE '$yr%')";
