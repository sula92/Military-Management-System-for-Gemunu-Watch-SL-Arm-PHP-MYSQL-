...
<body>
<h1 align="center">ALL OTHER DEATH SPOUSES</h1>
<?php
...
$sql = "SELECT * FROM other_death_spouse ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM other_death_spouse ";
...
?> 
<h3>Total Spouses Count is:<?php echo $inc?></h3>
