...
include('Config.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM mbo_other_injured_sick_spouse WHERE NIC_No='$_POST[txtidno]'";
	...
	if(isset($_POST['btnSearch'])){
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				//Assigning the Record
				$nic=$row['NIC_No'];
				$sfnm=$row['Spouses_Full_Name'];
				$nmin=$row['Name_With_Initials'];
				$dob=$row['Date_of_Birth'];
				$pob=$row['Place_of_Birth'];
				$bcn=$row['Birth_Certificate_No'];
				$mcno=$row['Marriage_Certificate_No'];
				$doma=$row['Date_of_Marriage'];
				$wmar=$row['Which_Marriage_of_the_Soldier'];
				$mast=$row['Marriage_Status'];
	...
	if(isset($_POST['btnNew'])){
		...
		mysqli_set_charset($conn,"utf8");
		$sql = "INSERT INTO mbo_other_injured_sick_spouse VALUES('$_POST[txtfino]','$_POST[txtregnum]','$_POST[txtrank]','$_POST[rsen]','$_POST[txtnm]','$_POST[txtfnm]','$_POST[txtaid]','$_POST[txtcu]','$_POST[doin]','$_POST[nic]','$_POST[sfnm]','$_POST[nmin]','$_POST[dob]','$_POST[pob]','$_POST[txtbcn]','$_POST[mcno]','$_POST[doma]','$_POST[wmar]','$_POST[mast]','$_POST[lsta]','$_POST[dode]','$_POST[dcpr]','$_POST[dcno]','$_POST[rel]','$_POST[eth]','$_POST[noch]','$_POST[nobs]','$_POST[lod]','$_POST[bnk]','$_POST[txtbra]','$_POST[accno]','$_POST[txtacn]','$_POST[txthadd]','$_POST[city]','$_POST[dis]','$_POST[pro]','$_POST[dsag]','$_POST[elect]','$_POST[gnd]','$_POST[nac]','$_POST[nps]','$_POST[mob]','$_POST[hpp]','$_POST[altc]','$_POST[txtemai]','$_POST[msal]','$_POST[whom]','$_POST[fwhe]','$_POST[hola]','$_POST[txthladd]','$_POST[abf]','$_POST[mondi]','$_POST[welf]','$_POST[dowp]','$_POST[hadd]','$_POST[comp]','$_POST[compd]','$_POST[amou]','$_POST[lfa]','$_POST[tta]','$_POST[ratp]')";
		//Read the Command
	...
	if(isset($_POST['btnSave'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "UPDATE mbo_other_injured_sick_spouse SET `File_No`='$_POST[txtfino]',`Regiment_No`='$_POST[txtregnum]',`Rank`='$_POST[txtrank]',`Rank_Seniority_Order`='$_POST[rsen]',`Name(Army_Form)`='$_POST[txtnm]',`Full_Name`='$_POST[txtfnm]',`Army_ID_No`='$_POST[txtaid]',`Current/Last_Unit`='$_POST[txtcu]',`Date_of_Medical_Board_Out`='$_POST[doin]',
		
		
		`NIC_No`='$_POST[nic]',`Spouses_Full_Name`='$_POST[sfnm]',`Name_With_Initials`='$_POST[nmin]',`Date_of_Birth`='$_POST[dob]',`Place_of_Birth`='$_POST[pob]',`Birth_Certificate_No`='$_POST[txtbcn]',
		`Marriage_Certificate_No`='$_POST[mcno]',`Date_of_Marriage`='$_POST[doma]',`Which_Marriage_of_the_Soldier`='$_POST[wmar]',`Marriage_Status`='$_POST[mast]',
		`Life_Status`='$_POST[lsta]',`Date_of_Death`='$_POST[dode]',`Death_Certificate_Provided`='$_POST[dcpr]',`Death_Certificate_Number`='$_POST[dcno]',`Religion`='$_POST[rel]',`Ethnicity`='$_POST[eth]',`Number_of_Children_Have_Got`='$_POST[noch]',`Number_of_Brothers_&_Sisters`='$_POST[nobs]',`List_of_Dependents`='$_POST[lod]',`Bank_Name`='$_POST[bnk]',`Branch`='$_POST[txtbra]',`Account_Number`='$_POST[accno]',`Account_Name`='$_POST[txtacn]',
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick_spouse WHERE NIC_No='$_POST[txtidno]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "INSERT INTO dambo_other_injured_sick_spouse VALUES('$_POST[txtfino]','$_POST[txtregnum]','$_POST[txtrank]','$_POST[rsen]','$_POST[txtnm]','$_POST[txtfnm]','$_POST[txtaid]','$_POST[txtcu]','$_POST[doin]','$_POST[nic]','$_POST[sfnm]','$_POST[nmin]','$_POST[dob]','$_POST[pob]','$_POST[txtbcn]','$_POST[mcno]','$_POST[doma]','$_POST[wmar]','$_POST[mast]','$_POST[lsta]','$_POST[dode]','$_POST[dcpr]','$_POST[dcno]','$_POST[rel]','$_POST[eth]','$_POST[noch]','$_POST[nobs]','$_POST[lod]','$_POST[bnk]','$_POST[txtbra]','$_POST[accno]','$_POST[txtacn]','$_POST[txthadd]','$_POST[city]','$_POST[dis]','$_POST[pro]','$_POST[dsag]','$_POST[elect]','$_POST[gnd]','$_POST[nac]','$_POST[nps]','$_POST[mob]','$_POST[hpp]','$_POST[altc]','$_POST[txtemai]','$_POST[msal]','$_POST[whom]','$_POST[fwhe]','$_POST[hola]','$_POST[txthladd]','$_POST[abf]','$_POST[mondi]','$_POST[welf]','$_POST[dowp]','$_POST[hadd]','$_POST[comp]','$_POST[compd]','$_POST[amou]','$_POST[lfa]','$_POST[tta]','$_POST[ratp]')";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
//Check the Button
	if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick_spouse WHERE NIC_No='$_POST[txtidno]' ||  NIC_No='$_POST[nic]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
   ...
   <a href="mbo_other_injured_sick_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
    <a href="mbo_other_injured_sick_spouse.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="mbo_other_injured_sick/spouse/allmbo_other_injured_sick_spouse.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER INJURED/SICK-MEDICAL BOARD OUT SPOUSES</center></a></center>
 



  <center><a href="mbo_other_injured_sick/spouse/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="mbo_other_injured_sick/spouse/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="mbo_other_injured_sick/spouse/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
  
   <center> <a href="mbo_other_injured_sick/spouse/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="mbo_other_injured_sick/spouse/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="mbo_other_injured_sick/spouse/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div style="margin-left:200px"><button onclick="w3.toggleShow('#qui')">&#9776;</button> </div>
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
     <h1 style="margin-left:18%">OTHER INJURED/SICK-MEDICAL BOARD OUT SPOUSES</h1></center>
  </div>
</div>
 ...
 <form class="" action="#" name="frmStud" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
     ...
     <div class="col-25"><input type="submit" name="btnSearch" value="Search Record"/>                        </div>                                                    
        <div class="col-75"><input type="text" name="txtidno"  placeholder="කලත්රයාගේ හැඳුනුම් අංකය" value="" /></div>
	...
	if(isset($_POST['btnSearch'])){	   
         ...
         echo "<img src = 'spouses_photos/$imagedisplay' style=\"float:right; width:210px;\" class=\"pic\"/>";
...
?>     
         ...
         <fieldset id="mil"><legend style="color:red">SOLDIER'S(HUSBAND'S) INFORMATION (සොල්දාදුවගේ (ස්වාමියාගේ) තොරතුරු)</legend>
        <div class="row"></div>
        <div class="row">
      ...
      <option value="01">01-FIELD MARSHAL(ෆීල්ඩ් මාර්ෂල්)</option>
          ...
          <div class="row">
            ...
            <div class="row"></div>
    <fieldset id="per"><legend style="color:red">SPOUSE'S PERSONAL DETAILS (පුද්ගලික විස්තර)</legend>  
           <div class="row">
            <div class="ld">
...
<div class="row">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Marriage Certificate No<br>(විවාහ සහතික අංක)</label>
      </div>
      <div class="col-75">
        <input type="text" id="mcno" name="mcno" placeholder="විවාහ සහතික අංක."  style="width:100%" value="<?php echo $mcno; ?>">

      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Date of Marriage(විවාහ දිනය)</label>
      </div>
      <div class="col-75">
        <input type="date" id="doma" name="doma"   style="width:100%" value="<?php echo $doma; ?>" />
      </div>
    </div>
    
      <div class="row">
            	<div class="ld"><label style="color:white">Which Marriage of the Soldier<br>(සොල්දාදුවාගේ කුමන විවාහයද?)</label></div>
                <div class="rd">
         <select id="wmar" name="wmar">
          ...
          <option value="Not Legally Married, but Having Children(නීත්යානුකූලව විවාහ නොවන නමුත් දරුවන් ඇත)">Not Legally Married, but Having Children(නීත්යානුකූලව විවාහ නොවන නමුත් දරුවන් ඇත)</option>
   ...
   <div class="row">
      <div class="col-25">
       <label for="fname" style="color:white">Marriage Status(විවාහ තත්ත්වය)</label><br>
      </div>
      <div class="col-75">
    ...
    <div class="row">
     ...
     <fieldset><legend style="color:red">IF SPOUSE IS DEAD(කලත්රයා ජීවමාන නොවේ නම්)</legend>       
            <div class="row">
            	<div class="ld"><label>Date of Death(මරණයේ දිනයs)</label></div>
...
<center><h2 style="color:#3F6">SEARCH FOR ALL THE SPOUSES BELONGS TO THE SOLDIER</h2> 
...
xmlhttp.open("GET","mbo_other_injured_sick/spouse/select_spouse.php?spou="+document.getElementById("myInput").value,false);
xmlhttp.send(null);
