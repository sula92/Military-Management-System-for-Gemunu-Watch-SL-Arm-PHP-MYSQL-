...
<body>
<h1 align="center">ALL OTHER INJURED/SICK SPOUSES</h1>
<?php
...
$sql = "SELECT * FROM other_injured_sick_spouse ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM other_injured_sick_spouse ";
