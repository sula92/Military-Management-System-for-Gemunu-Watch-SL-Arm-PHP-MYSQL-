...
$sql = "SELECT * FROM other_injured_sick_spouse WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_injured_sick_spouse WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of OTHER INJURED/SICK SPOUSES is: $inc</h3>"
