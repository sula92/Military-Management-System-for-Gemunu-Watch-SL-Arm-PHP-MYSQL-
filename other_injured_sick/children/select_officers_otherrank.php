...
echo "<center><h2>ALL OTHER INJURED/SICK SOLDIERS $x</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_injured_sick_children WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_injured_sick_children WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of OTHER INJURED/SICK SOLDIER'S Children $x is: $inc</h3>"
