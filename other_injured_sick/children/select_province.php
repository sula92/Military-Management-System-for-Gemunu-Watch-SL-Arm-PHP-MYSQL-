...
$sql = "SELECT * FROM other_injured_sick_children WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_injured_sick_children WHERE (Province LIKE '$yr%')";
