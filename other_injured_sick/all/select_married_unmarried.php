...
echo "<center><h2>ALL $u OTHER INJURED SICK</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM other_injured_sick WHERE (Civil_Status LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_injured_sick WHERE (Civil_Status LIKE '$yr%')";
...
echo "<h3>TOTAL $u OTHER INJURED SICK COUNT IS: $inc</h3>"
