...
$sql = "SELECT * FROM other_injured_sick WHERE (	`Attributed/Not_Attributed_to_Military_Service` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_injured_sick WHERE (	`Attributed/Not_Attributed_to_Military_Service` LIKE '$yr%')";
...
echo "<h3>Total OTHER INJURED/SICK Count of $yr is: $inc</h3>"
