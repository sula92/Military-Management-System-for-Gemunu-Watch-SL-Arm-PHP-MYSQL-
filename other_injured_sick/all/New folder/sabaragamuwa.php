...
<body>
<h1 align="center">ALL MIA FROM SABARAGAMUWA PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'sabara%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'sabara%')";
...
echo "<h3>Total MIA Soldiers from Sabaragamuwa Province: $inc</h3>"
