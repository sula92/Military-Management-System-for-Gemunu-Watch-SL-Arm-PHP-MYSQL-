...
$sql = "SELECT * FROM other_injured_sick_brosis WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
echo "<h3>Total $ran Count of OTHER OTHER INJURED SICK & SISTERS is: $inc</h3>"
