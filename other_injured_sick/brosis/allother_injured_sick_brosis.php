...
<body>
<h1 align="center">ALL OTHER INJURED SICK BROTHERS & SISTERS</h1>
<?php
...
$sql = "SELECT * FROM other_injured_sick_brosis ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM other_injured_sick_brosis ";
...
?> 
<h3>Total OTHER INJURED SICK SOLDIER'S Brothers & Sisters Count is:<?php echo $inc?></h3>
