...
include('Config.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM dambo_other_injured_sick_spouse WHERE NIC_No='$_POST[txtidno]'";
	...
	if(isset($_POST['btnSave'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "UPDATE dambo_other_injured_sick_spouse SET `File_No`='$_POST[txtfino]',`Regiment_No`='$_POST[txtregnum]',`Rank`='$_POST[txtrank]',`Rank_Seniority_Order`='$_POST[rsen]',`Name(Army_Form)`='$_POST[txtnm]',`Full_Name`='$_POST[txtfnm]',`Army_ID_No`='$_POST[txtaid]',`Current/Last_Unit`='$_POST[txtcu]',`Date_of_Medical_Board_Out`='$_POST[doin]',
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM dambo_other_injured_sick_spouse WHERE NIC_No='$_POST[txtidno]' ||  NIC_No='$_POST[nic]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
   ...
   <a href="dambo_other_injured_sick_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
    <a href="dambo_other_injured_sick_spouse.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="dambo_other_injured_sick/spouse/alldambo_other_injured_sick_spouse.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER INJURED/SICK-DEATH AFTER MEDICAL BOARD OUT SPOUSES</center></a></center>
 



  <center><a href="dambo_other_injured_sick/spouse/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="dambo_other_injured_sick/spouse/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="dambo_other_injured_sick/spouse/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
  
   <center> <a href="dambo_other_injured_sick/spouse/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="dambo_other_injured_sick/spouse/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="dambo_other_injured_sick/spouse/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div style="margin-left:200px"><button onclick="w3.toggleShow('#qui')">&#9776;</button> </div>
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
     <h1 style="margin-left:18%">OTHER INJURED/SICK-DEATH AFTER MEDICAL BOARD OUT SPOUSES</h1></center>
  </div>
</div>
...
xmlhttp.open("GET","dambo_other_injured_sick/spouse/select_spouse.php?spou="+document.getElementById("myInput").value,false);
xmlhttp.send(null);
