...
if (!mysqli_query($con,$sql))
  ...
  {echo '<script language="javascript">';
	...
	if(isset($_POST['btnDelete'])){
		...
		/*$sql = "SELECT * FROM photos where Regiment_Number ='$_POST[txtregno]' || Regiment_Number='$_POST[txtregnum]'";
...
while ($documents = mysqli_fetch_array($result)) {
	...
	$imagedisplay =$documents['Image']; }*/
		...
		$sql = "DELETE FROM photos WHERE Regiment_Number='$_POST[txtregno]' || Regiment_Number='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
