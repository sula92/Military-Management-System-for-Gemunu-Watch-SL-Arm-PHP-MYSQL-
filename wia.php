...
include('image.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM wia WHERE Regiment_No='$_POST[txtregno]'";
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM wia WHERE Regiment_No='$_POST[txtregno]' || Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
//Check the Button
	if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM wia WHERE Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="wia.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="wia/all/allwia.php" class="w3-bar-item w3-button" style="color:white"><center>ALL WIA</center></a></center>
 
 <center> <a href="wia/all/per.php" class="w3-bar-item w3-button" style="color:white"><center>ALL NEEDED PERSONAL DETAILS OF A SOLDIER</center></a></center>


  <center><a href="wia/all/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="wia/all/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="Wia/all/period.php" class="w3-bar-item w3-button" style="color:white"><center>PERIOD WISE</center></a></center>
 
  <center> <a href="wia/all/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
   
  <center> <a href="wia/all/married_unmarried.php" class="w3-bar-item w3-button" style="color:white"><center>MARRIED / UNMARRIED  WISE</center></a></center>
  
   <center> <a href="wia/all/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="wia/all/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="wia/all/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div class="w3-teal">
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
      <h1>WOUNDED IN ACTION</h1></center>
  </div>
</div>
...
<fieldset><legend style="color:red">WIA INFORMATION</legend>

<div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Reason for WIA(තුවාල සඳහා හේතුව)</label>
      </div>
      <div class="col-75">
         <input type="text" id="rfm" name="txtrfm" value="<?php echo $rfm; ?>"/>
...
<div class="row">
  ...
  <div class="row">
      ...
      <option value="Yes,Has Alredy been Paid in Fully(ඔව්, දැනටමත් සම්පූර්ණයෙන්ම ගෙවා තිබේ)">Yes,Has Alredy been Paid in Fully(ඔව්, දැනටමත් සම්පූර්ණයෙන්ම ගෙවා තිබේ)</option>
      <option value="Yes, Has to be Paid(ඔව්, ගෙවිය යුතු වේ)">Yes, Has to be Paid(ඔව්, ගෙවිය යුතු වේ)</option>
      <option value="</option>
      <option value="Not at All(කොහෙත්ම නැහැ)<">Not at All(කොහෙත්ම නැහැ)</option>
      <option value="Unknown(නොදන්නා)">Unknown(නොදන්නා)</option>
   </select>
