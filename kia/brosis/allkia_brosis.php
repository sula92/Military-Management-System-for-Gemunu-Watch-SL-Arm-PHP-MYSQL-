...
<body>
<h1 align="center">ALL KIA BROTHERS & SISTERS</h1>
<?php
...
$sql = "SELECT * FROM kia_brosis ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM kia_brosis ";
...
?> 
<h3>Total KIA Brothers & Sisters Count is:<?php echo $inc?></h3>
