...
echo "<center><h2>ALL KIA BROTHERS & SISTERSS $x</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM kia_brosis WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM kia_brosis WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of KIA BROTHERS & SISTERS $x is: $inc</h3>"
