...
<body>
<h1 align="center">ALL KIA CHILDREN</h1>
<?php
...
$sql = "SELECT * FROM kia_children ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM kia_children ";
...
?> 
<h3>Total KIA Children Count is:<?php echo $inc?></h3>
