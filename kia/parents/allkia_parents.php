...
<body>
<h1 align="center">ALL KIA PARENTS</h1>
<?php
...
$sql = "SELECT * FROM kia_parents ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM kia_parents ";
...
?> 
<h3>Total KIA Prents Count is:<?php echo $inc?></h3>
