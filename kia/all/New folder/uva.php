...
<body>
<h1 align="center">ALL MIA FROM UVA PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'uva%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'uva%')";
...
echo "<h3>Total MIA Soldiers from Uva: $inc</h3>"
