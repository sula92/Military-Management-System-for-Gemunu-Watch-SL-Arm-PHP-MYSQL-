...
<body>
<h1 align="center">ALL MIA FROM NORTHERN PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'Northern%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'northern%')";
...
echo "<h3>Total MIA Soldiers from Nothern Province: $inc</h3>"
