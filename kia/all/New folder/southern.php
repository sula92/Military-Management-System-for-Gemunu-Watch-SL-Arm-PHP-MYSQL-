...
<body>
<h1 align="center">ALL MIA FROM SOUTHERN PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'sou%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'Sout%')";
...
echo "<h3>Total MIA Soldiers from Southern Province: $inc</h3>"
