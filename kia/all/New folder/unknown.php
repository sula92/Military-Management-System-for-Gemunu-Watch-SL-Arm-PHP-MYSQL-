...
<body>
<h1 align="center">ALL MIA FROM UNKNOWN PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'unkn%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'unkn%')";
...
echo "<h3>Total MIA Soldiers from Unknown Province: $inc</h3>"
