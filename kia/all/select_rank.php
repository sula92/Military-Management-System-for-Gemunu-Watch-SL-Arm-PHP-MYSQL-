...
$sql = "SELECT * FROM kia WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM kia WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of KIA is: $inc</h3>"
