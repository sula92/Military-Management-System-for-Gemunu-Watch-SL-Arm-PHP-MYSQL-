...
?><br><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#contact" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-money fa-fw w3-margin-right"></i>LOANS,PROPERTY,ASSETS<br/> & COMPONSATION INFORMATION</a>
...
<div class="w3-sidebar w3-bar-block w3-dark-grey w3-card w3-animate-right" style="display:none;right:0; width:30%; " id="rightMenu">
 ...
 <center> <a href="allkia.php" class="w3-bar-item w3-button" style="color:white"><center>ALL KIA</center></a></center>
 ...
 <center> <a href="officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
  ...
  <header id="portfolio">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
      ...
      <a href="http://localhost/gw/kia/all/per.php"><button class="w3-button w3-white w3-hide-small"><i class="fa fa-photo w3-margin-right"></i>BACK</button></a>
      <a  href="http://localhost/gw/kia.php"><button class="w3-button w3-white w3-hide-small"><i class="fa fa-map-pin w3-margin-right"></i>BACK TO KIA</button></a>
    </div>
    </div>
  </header>
