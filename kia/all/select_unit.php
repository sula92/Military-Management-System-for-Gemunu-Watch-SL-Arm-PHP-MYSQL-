...
$sql = "SELECT * FROM kia WHERE (`Current/Last_Unit` LIKE '$uni%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM kia WHERE (`Current/Last_Unit` LIKE '$uni%')";
...
echo "<h3>Total Count of KIA From $uni is: $inc</h3>"
?> 
