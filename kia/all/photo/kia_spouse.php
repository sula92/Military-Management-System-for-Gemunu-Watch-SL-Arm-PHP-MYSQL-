...
$sql = "SELECT * FROM kia_spouse WHERE (NIC_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
$conn->close();
	...
	if(isset($_POST['btnNew'])){
		...
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo "<br><br><br><h2>New record created successfully</h3>";
		}
		else{
	...
	if(isset($_POST['btnSave'])){
		...
		//Create the Query(Insert Record)
		$sql = "UPDATE kia_spouse SET Home_Adress='$_POST[hadd]',Address='$_POST[Address]',DOB='$_POST[txtDOB]',Gender='$_POST[txtGender]',TelNo='$_POST[txtTelNo]' WHERE NIC_No='$_POST[nic]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM kia_spouse WHERE NIC_No='$_POST[nic]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="office.html" class="w3-bar-item w3-button w3-padding-large w3-hide-small">OFFICE</a>
 ...
 <form class="" action="#" name="frmStud" method="post">
    ...
    <div class="row">
     ...
     <div class="col-25"><input type="submit" name="btnSearch" value="Search Record"/>                        </div>                                                    
        ...
        <div class="row3">
          <div class="pic"><input type="file" name="filepic" /></div>
          
         <div style="float:right; position:relative; width:80%; height:100%; border:2px solid;">
         
          <div class="image"><input type="submit" name="adim" value="Add Image" onClick="cle()"/></div>
...
<div class="row">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname" style="color:blue">Marriage Certificate No<br>(විවාහ සහතික අංක)</label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname" style="color:blue">Date of Marriage(විවාහ දිනය)</label>
      </div>
      <div class="col-75">
      ...
      <div class="row">
            	<div class="ld"><label style="color:blue">Which Marriage of the Soldier<br>(සොල්දාදුවාගේ කුමන විවාහයද?)</label></div>
                <div class="rd">
   ...
   <div class="row">
      <div class="col-25">
       <label for="fname" style="color:blue">Marriage Status(විවාහ තත්ත්වය)</label><br>
      </div>
      <div class="col-75">
