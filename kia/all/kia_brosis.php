...
$sql = "SELECT * FROM kia_brosis WHERE (NIC_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
<div class="w3-sidebar w3-bar-block w3-dark-grey w3-card w3-animate-right" style="display:none;right:0; width:30%; " id="rightMenu">
 ...
 <center> <a href="allkia.php" class="w3-bar-item w3-button" style="color:white"><center>ALL MIA</center></a></center>
 ...
 <center> <a href="officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>KIA BROTHERS/SISTERS_<?php echo $sfnm; ?></b></h1>
...
<form class="w3-container">
    ...
    <fieldset><legend style="color:red">BROTHER/SISTER'S PERSONAL DETAILS (සහෝදර/සහෝදරිය පුද්ගලික විස්තර)</legend>  
           <div class="row">
            <div class="ld">
              <label for="lname" style="color:blue">Brother/Sister's NIC Number<br>(ජාතික හැදුනුම්පත් අංකය)</label>
            </div>
           <div class="rd">
         ...
         <div class="row">
            	<div class="ld"><label style="color:blue">Relationship to the Soldier</label></div>
                <div class="rd">
