...
<a href="http://localhost/gw/kia.php"><button class="w3-button w3-round-xxxlarge w3-blue">BACK TO KIA</button></a>
...
<div class="container">
  <h1>ALL KIA LIST(DATE OF DEATH,PERIOD WISE)</h1>
...
echo "<center><h2>ALL KIA FROM $sy TO $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM kia WHERE (Date_of_Incident BETWEEN '$sy' AND '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM kia WHERE (Date_of_Incident BETWEEN '$sy' AND '$yr%')";
...
echo "<h3>Total MIA Count of KIA From $sy TO $yr is: $inc</h3>";
