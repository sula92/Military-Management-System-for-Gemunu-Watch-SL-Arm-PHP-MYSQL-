...
include('image.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM dambo_wia WHERE Regiment_No='$_POST[txtregno]'";
...
`Reason_for_Death`='$_POST[txtrfd]',`Date_of_Death`='$_POST[dode]',`Area_that_Death_Occured`='$_POST[txtardo]',`Police_Report_Number`='$_POST[txtprn]',`Death_Certificate_Has_Issued`='$_POST[txtdchi]',`Death_Certificate_Issued_Date`='$_POST[isda]',`Death_Certificate_Number`='$_POST[dcno]',`Court_of_Inquiry_About_the_Death`='$_POST[coin]',`Army_Commanders_Decision_About_the_Death`='$_POST[adeci]',			
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM dambo_wia WHERE Regiment_No='$_POST[txtregno]' || Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="dambo_wia.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="dambo_wia/all/alldambo_wia.php" class="w3-bar-item w3-button" style="color:white"><center>ALL WIA DEATH AFTER MEDICAL BOARD OUT</center></a></center>
 
<center> <a href="dambo_wia/all/per.php" class="w3-bar-item w3-button" style="color:white"><center>ALL NEEDED PERSONAL DETAILS OF A SOLDIER</center></a></center>


  <center><a href="dambo_wia/all/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="dambo_wia/all/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
 <center> <a href="dambo_wia/all/period.php" class="w3-bar-item w3-button" style="color:white"><center>PERIOD WISE</center></a></center>
 
  <center> <a href="dambo_wia/all/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
   
  <center> <a href="dambo_wia/all/married_unmarried.php" class="w3-bar-item w3-button" style="color:white"><center>MARRIED / UNMARRIED  WISE</center></a></center>
  
   <center> <a href="dambo_wia/all/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="dambo_wia/all/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="dambo_wia/all/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
