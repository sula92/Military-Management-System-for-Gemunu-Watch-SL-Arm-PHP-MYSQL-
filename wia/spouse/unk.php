...
<body>
<h1 align="center">ALL MIA WHO ARE UNKNOWN WHETHER COMPENSATED OR NOT </h1>
...
$sql = "SELECT * FROM `mia_spouse` WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE 'unk%')";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia_spouse WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE 'unk%')";
...
echo "<h3>Total Count of SPOUSES MIA WHO ARE UNKNOWN WHETHER COMPENSATED OR NOT: $inc</h3>"
