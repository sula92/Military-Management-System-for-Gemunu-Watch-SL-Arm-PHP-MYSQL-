...
echo "<center><h2>ALL WIA SOLDIERS $x</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM wia_children WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia_children WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of WIA Children $x is: $inc</h3>"
