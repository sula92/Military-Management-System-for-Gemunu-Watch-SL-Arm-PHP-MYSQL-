...
<body>
<h1 align="center">ALL WIA CHILDREN</h1>
<?php
...
$sql = "SELECT * FROM wia_children ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM wia_children ";
...
?> 
<h3>Total WIA SOLDIER'S Children Count is:<?php echo $inc?></h3>
