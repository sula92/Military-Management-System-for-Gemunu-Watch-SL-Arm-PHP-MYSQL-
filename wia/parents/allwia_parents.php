...
<body>
<h1 align="center">ALL WIA SOLDIER'S PARENTS</h1>
<?php
...
$sql = "SELECT * FROM wia_parents ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM wia_parents ";
...
?> 
<h3>Total WIA Prents Count is:<?php echo $inc?></h3>
