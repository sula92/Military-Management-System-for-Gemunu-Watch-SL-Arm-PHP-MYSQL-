...
echo "<center><h2>ALL THE $ran of WIA PARENTS</center></h2>";

mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM wia_parents WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia_parents WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of WIA PARENTS is: $inc</h3>"
