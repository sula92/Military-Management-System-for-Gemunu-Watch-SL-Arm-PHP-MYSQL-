...
$sql = "SELECT * FROM wia WHERE (Date_of_Incident LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia WHERE (`Date_of_Incident` LIKE '$yr%')";
...
echo "<h3>Total Count of WIA In $yr is: $inc</h3>"
