...
$sql = "SELECT * FROM wia WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '%$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '$yr%')";
...
echo "<h3>TOTAL $x WIA COUNT IS: $inc</h3>"
