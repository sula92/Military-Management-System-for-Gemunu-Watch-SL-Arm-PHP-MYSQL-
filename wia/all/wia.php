...
$sql = "SELECT * FROM wia WHERE (Regiment_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="wia_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BROTHERS/SISTERS</a>
     ...
     <a href="http://localhost/gw/wia_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="http://localhost/gw/wia_children.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CHILDREN</a>
...
<div class="row">
      <div class="col-25">
        <label for="lname" style="color:blue">Reason for WIA(තුවාල සඳහා හේතුව)</label>
      </div>
      <div class="col-75">
         <select id="rfm" name="txtrfm">
     <option value=""><?php echo $rfm; ?></option>   
     <option value="Bomb Blast(බෝම්බ පිපිරීමක්)">Bomb Blast(බෝම්බ පිපිරීමක්)</option>
     <option value="Gun Shot(වෙඩි ප්රහාරයක්)">Gun Shot(වෙඩි ප්රහාරයක්)</option>
     <option value="Missile Attack(මිසයිල ප්රහාරයක්)">Missile Attack(මිසයිල ප්රහාරයක්)</option>
     <option value="Other Attack(වෙනත් ප්රහාරයක්)">Other Attack(වෙනත් ප්රහාරයක්)</option>
     <option value="Armored Car Attack(යුද ටැංකි ප්රහාරයක්)">Armored Car Attack(යුද ටැංකි ප්රහාරයක්)</option>
     <option value="Trapped(උගුලක්)">Trapped(උගුලක්)</option>
     
     <option value="Other Blast(වෙනත් අනතුරක්)<">Other Accident(වෙනත් අනතුරක්)</option>
     <option value="Other(වෙනත්)">Other(වෙනත්)</option>
