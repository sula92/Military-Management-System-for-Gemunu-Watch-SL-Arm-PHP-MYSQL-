...
<a href="http://localhost/gw/wia.php"><button class="w3-button w3-round-xxxlarge w3-blue">BACK TO WIA</button></a>
...
<div class="container">
  <h1>WIA LIST(DATE OF INCIDENT,PERIOD WISE)</h1>
...
echo "<center><h2>ALL WIA FROM $sy TO $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM wia WHERE (Date_of_Incident BETWEEN '$sy' AND '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia WHERE (Date_of_Incident BETWEEN '$sy' AND '$yr%')";
...
echo "<h3>Total Count of WIA FROM $sy TO $yr is: $inc</h3>";
