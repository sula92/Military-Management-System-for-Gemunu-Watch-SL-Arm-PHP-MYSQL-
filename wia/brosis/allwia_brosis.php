...
<body>
<h1 align="center">ALL WIA BROTHERS & SISTERS</h1>
<?php
...
$sql = "SELECT * FROM wia_brosis ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM wia_brosis ";
...
?> 
<h3>Total WIA Brothers & Sisters Count is:<?php echo $inc?></h3>
