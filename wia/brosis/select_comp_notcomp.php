...
echo "<center><h2>ALL WIA SOLDIERS BROTHERS & SISTERS $x  </center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM wia_brosis WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia_brosis WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '$yr%')";
...
echo "<h3>TOTAL $x WIA BROTHERS & SISTERS COUNT IS: $inc</h3>"
