...
echo "<center><h2>ALL WIA BROTHERS & SISTERS IN $uni</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM wia_brosis WHERE (`Current/Last_Unit` LIKE '$uni%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia_brosis WHERE (`Current/Last_Unit` LIKE '$uni%')";
...
echo "<h3>Total Count of WIA BROTHERS & SISTERS From $uni is: $inc</h3>"
?> 
