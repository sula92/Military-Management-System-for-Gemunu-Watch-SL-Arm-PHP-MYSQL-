...
echo "<center><h2>ALL WIA IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM wia_brosis WHERE (Date_of_Incident LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM wia_brosis WHERE (`Date_of_Incident` LIKE '$yr%')";
