...
$sql = "SELECT * FROM absent_children WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent_children WHERE (Province LIKE '$yr%')";
...
echo "<h3>Total Count of ABSENT SOLDIERS'S CHILDREN In $yr is: $inc</h3>"
