...
echo "<center><h2>ALL ABSENT SOLDIER'S CHILDREN $x  </center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM absent_children WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '%$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent_children WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '$yr%')";
...
echo "<h3>TOTAL $x ABSENT CHILDREN COUNT IS: $inc</h3>"
