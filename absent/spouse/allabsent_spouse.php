...
<body>
<h1 align="center">ALL ABSENT SOLDIER'S SPOUSES</h1>
<?php
...
$sql = "SELECT * FROM absent_spouse ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM absent_spouse ";
