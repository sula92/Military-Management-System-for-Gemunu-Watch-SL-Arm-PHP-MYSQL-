...
<body>
<h1 align="center">ALL ABSENT BROTHERS & SISTERS</h1>
<?php
...
$sql = "SELECT * FROM absent_brosis ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM absent_brosis ";
...
?> 
<h3>Total Absent soldier's Brothers & Sisters Count is:<?php echo $inc?></h3>
