...
echo "<center><h2>ALL ABSENT SOLDIER'S BROTHERS & SISTERSS $x</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM absent_brosis WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent_brosis WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of ABSENT BROTHERS & SISTERS $x is: $inc</h3>"
