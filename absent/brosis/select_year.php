...
echo "<center><h2>ALL ABSENT SOLDIER'S BROTHER'S & SISTER'S IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM absent_brosis WHERE (`Absent_Date` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent_brosis WHERE (`Date_of_Incident` LIKE '$yr%')";
