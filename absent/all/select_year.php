...
$sql = "SELECT * FROM absent WHERE (Absent_Date LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent WHERE (`Absent_Date` LIKE '$yr%')";
...
echo "<h3>Total Count of ABSENT In $yr is: $inc</h3>"
