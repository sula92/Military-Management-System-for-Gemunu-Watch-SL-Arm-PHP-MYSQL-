...
$sql = "SELECT * FROM absent WHERE (Regiment_No = '$reg') ORDER BY Rank_Seniority_Order";
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://localhost/gw/absent_children.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CHILDREN</a>
    <a href="absent_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BROTHERS/SISTERS</a>
    
     <a href="http://localhost/gw/absent_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
     
    <a href="http://localhost/gw/absent.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="http://localhost/gw/absent_children.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CHILDREN</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="allabsent.php" class="w3-bar-item w3-button" style="color:white"><center>ALL ABSENT</center></a></center>
...
<div class="row" id="kia">
  ...
  <div class="row">
      <div class="col-25">
        <label for="fname" style="color:blue">Absent Date (දිනය)</label>
      </div>
      <div class="col-75">
     ...
     <div class="row">
      <div class="col-25">
        <label for="fname" style="color:blue">Absent Time (වේලාව)</label>
      </div>
      <div class="col-75">
...
<div class="row">
      <div class="col-25">
        <label for="lname" style="color:blue">MAIN CATEGORY</label>
      </div>
      <div class="col-75">
