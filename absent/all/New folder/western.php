...
<body>
<h1 align="center">ALL MIA FROM WESTERN PROVINCE</h1>
<?php
...
$sql = "SELECT * FROM mia WHERE (province LIKE 'west%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mia WHERE (`Province` LIKE 'West%')";
...
echo "<h3>Total MIA Soldiers from Western Province: $inc</h3>"
?> 
