...
$sql = "SELECT * FROM absent_parents WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent_parents WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of ABSENT SOLDIR'S PARENTS is: $inc</h3>"
