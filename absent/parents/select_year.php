...
echo "<center><h2>ALL ABSENT SOLDIERS'S PARENS IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM absent_parents WHERE (Absent_Date LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent_parents WHERE (`Absent_Date` LIKE '$yr%')";
...
echo "<h3>Total Count of ABSENT SOLDIER'S PARENTS In $yr is: $inc</h3>"
