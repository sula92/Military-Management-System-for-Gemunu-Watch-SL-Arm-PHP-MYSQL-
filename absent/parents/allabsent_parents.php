...
<body>
<h1 align="center">ALL ABSENT SOLDIER'S PARENTS</h1>
<?php
...
$sql = "SELECT * FROM absent_parents ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM absent_parents ";
...
?> 
<h3>Total ABSENT Prents Count is:<?php echo $inc?></h3>
