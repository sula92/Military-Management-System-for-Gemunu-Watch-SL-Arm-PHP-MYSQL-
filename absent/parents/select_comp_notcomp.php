...
echo "<center><h2>ALL OTHER ABSENT SOLDIER'S PARENTS $x  </center></h2>";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM absent_parents WHERE (`Has_the_Soldier_Got_Any_Compensation_From_SL_Army` LIKE '$yr%')";
...
echo "<h3>TOTAL $x OTHER ABSENT SOLDIER'S PARENTS COUNT IS: $inc</h3>"
