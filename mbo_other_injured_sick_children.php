...
include('Config.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM mbo_other_injured_sick_children WHERE NIC_No='$_POST[txtidno]'";
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				...
				$doin=$row['Date_of_Medical_Board_Out'];
	...
	if(isset($_POST['btnNew'])){
		...
		mysqli_set_charset($conn,"utf8");
		$sql = "INSERT INTO mbo_other_injured_sick_children VALUES('$_POST[txtfino]','$_POST[txtregnum]','$_POST[txtrank]','$_POST[rsen]','$_POST[txtnm]','$_POST[txtfnm]','$_POST[txtaid]','$_POST[txtcu]','$_POST[doin]','$_POST[nic]','$_POST[relp]','$_POST[sfnm]','$_POST[nmin]','$_POST[dob]','$_POST[pob]','$_POST[txtbcn]','$_POST[mcno]','$_POST[doma]','$_POST[wmar]','$_POST[mast]','$_POST[lsta]','$_POST[dode]','$_POST[dcpr]','$_POST[dcno]','$_POST[prsc]','$_POST[hisc]','$_POST[uni]','$_POST[educ]','$_POST[schol]','$_POST[rel]','$_POST[eth]','$_POST[noch]','$_POST[nobs]','$_POST[lod]','$_POST[bnk]','$_POST[txtbra]','$_POST[accno]','$_POST[txtacn]','$_POST[txthadd]','$_POST[city]','$_POST[dis]','$_POST[pro]','$_POST[dsag]','$_POST[elect]','$_POST[gnd]','$_POST[nac]','$_POST[nps]','$_POST[mob]','$_POST[hpp]','$_POST[altc]','$_POST[txtemai]','$_POST[msal]','$_POST[whom]','$_POST[fwhe]','$_POST[hola]','$_POST[txthladd]','$_POST[abf]','$_POST[mondi]','$_POST[welf]','$_POST[dowp]','$_POST[hadd]','$_POST[comp]','$_POST[compd]','$_POST[amou]','$_POST[lfa]','$_POST[tta]','$_POST[ratp]')";
		//Read the Command
	...
	if(isset($_POST['btnSave'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "UPDATE mbo_other_injured_sick_children SET `File_No`='$_POST[txtfino]',`Regiment_No`='$_POST[txtregnum]',`Rank`='$_POST[txtrank]',`Rank_Seniority_Order`='$_POST[rsen]',`Name(Army_Form)`='$_POST[txtnm]',`Full_Name`='$_POST[txtfnm]',`Army_ID_No`='$_POST[txtaid]',`Current/Last_Unit`='$_POST[txtcu]',`Date_of_Medical_Board_Out`='$_POST[doin]',
		
		`NIC_No`='$_POST[nic]',`Relationship_to_the_Soldier`='$_POST[relp]',`Childs_Full_Name`='$_POST[sfnm]',`Name_With_Initials`='$_POST[nmin]',`Date_of_Birth`='$_POST[dob]',`Place_of_Birth`='$_POST[pob]',`Birth_Certificate_No`='$_POST[txtbcn]',
		`Mothers_Name`='$_POST[mcno]',`Mothers_ID_Number`='$_POST[doma]',`Which_Child_of_the_Soldier`='$_POST[wmar]',`Childs_Marriage_Status`='$_POST[mast]',
		
		`Life_Status`='$_POST[lsta]',`Date_of_Death`='$_POST[dode]',`Death_Certificate_Provided`='$_POST[dcpr]',`Death_Certificate_Number`='$_POST[dcno]',
		`Primary_School`='$_POST[prsc]',`High_School`='$_POST[hisc]',`University`='$_POST[uni]',`Educational_Qualifications`='$_POST[educ]',`Scholarships_from_Army`='$_POST[schol]',
		`Religion`='$_POST[rel]',`Ethnicity`='$_POST[eth]',`Number_of_Children_Have_Got`='$_POST[noch]',`Number_of_Brothers_&_Sisters`='$_POST[nobs]',`List_of_Dependents`='$_POST[lod]',`Bank_Name`='$_POST[bnk]',`Branch`='$_POST[txtbra]',`Account_Number`='$_POST[accno]',`Account_Name`='$_POST[txtacn]',
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick_children WHERE NIC_No='$_POST[txtidno]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "INSERT INTO dambo_other_injured_sick_children VALUES('$_POST[txtfino]','$_POST[txtregnum]','$_POST[txtrank]','$_POST[rsen]','$_POST[txtnm]','$_POST[txtfnm]','$_POST[txtaid]','$_POST[txtcu]','$_POST[doin]','$_POST[nic]','$_POST[relp]','$_POST[sfnm]','$_POST[nmin]','$_POST[dob]','$_POST[pob]','$_POST[txtbcn]','$_POST[mcno]','$_POST[doma]','$_POST[wmar]','$_POST[mast]','$_POST[lsta]','$_POST[dode]','$_POST[dcpr]','$_POST[dcno]','$_POST[prsc]','$_POST[hisc]','$_POST[uni]','$_POST[educ]','$_POST[schol]','$_POST[rel]','$_POST[eth]','$_POST[noch]','$_POST[nobs]','$_POST[lod]','$_POST[bnk]','$_POST[txtbra]','$_POST[accno]','$_POST[txtacn]','$_POST[txthadd]','$_POST[city]','$_POST[dis]','$_POST[pro]','$_POST[dsag]','$_POST[elect]','$_POST[gnd]','$_POST[nac]','$_POST[nps]','$_POST[mob]','$_POST[hpp]','$_POST[altc]','$_POST[txtemai]','$_POST[msal]','$_POST[whom]','$_POST[fwhe]','$_POST[hola]','$_POST[txthladd]','$_POST[abf]','$_POST[mondi]','$_POST[welf]','$_POST[dowp]','$_POST[hadd]','$_POST[comp]','$_POST[compd]','$_POST[amou]','$_POST[lfa]','$_POST[tta]','$_POST[ratp]')";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
            echo 'alert("RECORD TRANSFERED SUCCESSFULLY!")';
            echo '</script>';
		}
		else{
			//Display Error Message
...
//Check the Button
	if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick_children WHERE NIC_No='$_POST[txtidno]' ||  NIC_No='$_POST[nic]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
            echo 'alert("RECORD TRANSFERED & REMOVED SUCCESSFULLY!")';
            echo '</script>';
		}
		else{
			//Display Error Message
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="mbo_other_injured_sick_spouse.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">SPOUSES</a>
  
    <a href="mbo_other_injured_sick_children.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CHILDREN</a>
    <a href="mbo_other_injured_sick_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BROTHERS/SISTERS</a>
    
     <a href="mbo_other_injured_sick_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
   
    <a href="mbo_other_injured_sick_children.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="mbo_other_injured_sick_spouse.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">SPOUSES</a>
  <a href="mbo_other_injured_sick_children.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CHILDREN</a>
  <a href="mbo_other_injured_sick_brosis.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">BROTHERS/SISTERS</a>
  <a href="mbo_other_injured_sick_parents.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">PARENTS</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="mbo_other_injured_sick/children/allmbo_other_injured_sick_children.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER INJURED/SICK MEDICAL BOARD OUT CHILDREN</center></a></center>
 



  <center><a href="mbo_other_injured_sick/children/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="mbo_other_injured_sick/children/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="mbo_other_injured_sick/children/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
  
   <center> <a href="mbo_other_injured_sick/children/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="mbo_other_injured_sick/children/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="mbo_other_injured_sick/children/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div style="margin-left:200px"><button onclick="w3.toggleShow('#qui')">&#9776;</button> </div>
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
     <h1 style="margin-left:18%">OTHER INJURED/SICK MEDICAL BOARD OUT CHILDREN</h1></center>
  </div>
</div>
...
<div class="container" style="style:0.85">
 ...
 <form class="" action="#" name="frmStud" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
     ...
     <div class="col-25"><input type="submit" name="btnSearch" value="Search Record"/>                        </div>                                                    
        <div class="col-75"><input type="text" name="txtidno"  placeholder="දරැවාගේ හැඳුනුම් අංකය" value="" /></div>
	...
	if(isset($_POST['btnSearch'])){	   
         ...
         echo "<img src = 'children_photos/$imagedisplay' style=\"float:right; width:210px;\" class=\"pic\"/>";
...
?>    
         ...
         <fieldset id="mil"><legend style="color:red">SOLDIER'S(FATHER'S) INFORMATION (සොල්දාදුවගේ (පියා) තොරතුරු)</legend>
        <div class="row"></div>
        <div class="row">
      ...
      <option value="01">01-FIELD MARSHAL(ෆීල්ඩ් මාර්ෂල්)</option>
          ...
          <div class="row">
            ...
            <div class="row">
            	<div class="ld">Date of Medical Board Out <br>(වෛද්‍ය මණ්ඩලයෙන් පිටවු දිනය)</div>
    ...
    <fieldset id="per">
         ...
         <div class="row">
            	<div class="ld"><label style="color:white">Relationship to the Soldier
           	    (සොල්දාදුවාට ඇති ඥාතිත්වය) </label></div>
                <div class="rd">
         <select id="relp" name="relp">
          <option value="<?php echo $relp; ?>"><?php echo $relp; ?></option>         
...
<div class="row">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Mothers Name<br>(මවගේ නම)</label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Mothers ID Number(මවගේ ජාතික හැදුනුම්පත් අංකය)</label>
      </div>
      <div class="col-75">
      ...
      <div class="row">
            	<div class="ld"><label style="color:white">Which Child of the Soldier<br>
           	    (සොල්දාදුවාගේ කුමන දරැවාද?)</label></div>
                <div class="rd">
         <select id="wmar" name="wmar">
          <option value="<?php echo $wmar; ?>"><?php echo $wmar; ?></option>         
   ...
   <div class="row">
      <div class="col-25">
       <label for="fname" style="color:white">Childs Marriage Status(දරැවා විවාහ තත්ත්වය)</label><br>
      </div>
      <div class="col-75">
         <select id="mast" name="mast">
      <option value="<?php echo $mast; ?>"><?php echo $mast; ?></option>
...
<div class="row">
      <div class="col-25">
        <label for="fname" style="color:white">Primary School (ප්රාථමික පාසල)</label>
      </div>
      <div class="col-75">
 ...
 <div class="row">
      <div class="col-25">
        <label for="fname" style="color:white">High School (උසස් පාසැල)</label>
      </div>
      <div class="col-75">
        <input type="text" id="hisc" name="hisc" placeholder="උසස් පාසැල.." style="width:100%" value="<?php echo $hisc; ?>" />
      </div>
    </div>
    
 <div class="row">
      <div class="col-25">
        <label for="fname" style="color:white">University (විශ්ව විද්‍යාලය)</label>
      </div>
      <div class="col-75">
...
<div class="row">
      <div class="col-25">
        <label for="subject" style="color:white">Educational Qualifications (අධ්‍යාපන සුදුසුකම්)</label>
      </div>
      <div class="col-75">
    ...
    <div class="row">
      <div class="col-25">
        <label for="subject" style="color:white">Scholarships From Army (යුද හමුදාවෙන් ලද ශිෂ්යත්ව)</label>
      </div>
      <div class="col-75">
...
<center><h2 style="color:#3F6">SEARCH FOR ALL THE CHILDRE BELONGS TO SOLDIER</h2> 
...
xmlhttp.open("GET","mbo_other_injured_sick/children/select_children.php?spou="+document.getElementById("myInput").value,false);
xmlhttp.send(null);
...
<div class="w3-container" style="height:100px"></div>
 ...
 <center><h1 class="w3-red">TRANFER TO OTHER INJURDE/SICK DEATH AFTER MEDICAL BOARD OUT</h1></center>
 
           
   <fieldset><legend style="color:red">TRANSFER TO MEDICAL BOARD OUT </legend>
  
 <h3 style="color:green">Click The Button To Transfer To DAMBO</h3> 
      <div style="height:40px"></div>
               ...
               <input type="submit" onclick='return confirm_tra(this);' class="w3-center w3-blue" name="btntra" value="Tranfer To OTHER INJURED/SICK-DAMBO" />
