...
include('image.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM dambo_other_injured_sick WHERE Regiment_No='$_POST[txtregno]'";
...
`Reason_for_Death`='$_POST[txtrfd]',`Date_of_Death`='$_POST[dode]',`Area_that_Death_Occured`='$_POST[txtardo]',`Police_Report_Number`='$_POST[txtprn]',`Death_Certificate_Has_Issued`='$_POST[txtdchi]',`Death_Certificate_Issued_Date`='$_POST[isda]',`Death_Certificate_Number`='$_POST[dcno]',`Court_of_Inquiry_About_the_Death`='$_POST[coin]',`Army_Commanders_Decision_About_the_Death`='$_POST[adeci]',		
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM dambo_other_injured_sick WHERE Regiment_No='$_POST[txtregno]' || Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="dambo_other_injured_sick.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left w3-black" style="width:200px; margin-top:-0.4%" id="mySidebar">
  ...
  <a href="#per" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">PERSONAL INFORMATION</a>
   <a href="#death" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">DEATH INFORMATION</a>
   <a href="#dambo" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">MEDICAL BOARD OUT INFORMATION</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="dambo_other_injured_sick/all/alldambo_other_injured_sick.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER INJURED/SICK-MEDICAL BOARD OUT</center></a></center>
 
<center> <a href="dambo_other_injured_sick/all/per.php" class="w3-bar-item w3-button" style="color:white"><center>ALL NEEDED PERSONAL DETAILS OF A SOLDIER</center></a></center>


  <center><a href="dambo_other_injured_sick/all/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="dambo_other_injured_sick/all/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
 <center> <a href="dambo_other_injured_sick/all/period.php" class="w3-bar-item w3-button" style="color:white"><center>PERIOD WISE</center></a></center>
 
  <center> <a href="dambo_other_injured_sick/all/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
   
  <center> <a href="dambo_other_injured_sick/all/married_unmarried.php" class="w3-bar-item w3-button" style="color:white"><center>MARRIED / UNMARRIED  WISE</center></a></center>
  
   <center> <a href="dambo_other_injured_sick/all/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="dambo_other_injured_sick/all/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="dambo_other_injured_sick/all/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div class="w3-teal">
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
      <h1 style="margin-left:18%">OTHER INJURED/SICK-DEATH AFTER MEDICAL BOARD OUT</h1></center>
  </div>
</div>
...
<fieldset id="dambo_other_injured_sick"><legend style="color:red">PREVIOUS CATEGORY INFORMATION (OTHER INJURED/SICK-MEDICAL BOARD OUT)</legend>
