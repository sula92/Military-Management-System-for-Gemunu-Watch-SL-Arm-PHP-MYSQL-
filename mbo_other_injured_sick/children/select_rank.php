...
echo "<center><h2>ALL THE CHILDREN of OTHER INJURED/SICK MEDICAL BOARD OUT SOLDIER'S $ran</center></h2>";

mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_other_injured_sick_children WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick_children WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of OTHER INJURED/SICK MEDICAL BOARD OUT SOLDIER'S CHILDREN is: $inc</h3>"
