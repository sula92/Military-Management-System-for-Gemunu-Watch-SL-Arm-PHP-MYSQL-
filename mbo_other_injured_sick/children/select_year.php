...
echo "<center><h2>ALL OTHER INJURED/SICK MEDICAL BOARD OUT SOLDIER'S CHILDREN IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_other_injured_sick_children WHERE (Date_of_Medical_Board_Out LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick_children WHERE (`Date_of_Medical_Board_Out` LIKE '$yr%')";
...
echo "<h3>Total Count of OTHER INJURED/SICK MEDICAL BOARD OUT SOLDIER'S CHILDREN In $yr is: $inc</h3>"
