...
echo "<center><h2>ALL THE $ran of OTHER INJURED/SICK MEDICAL BOARD OUT</center></h2>";

mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_other_injured_sick_brosis WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM other_injured_sick_brosis WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of OTHER INJURED/SICK MEDICAL BOARD OUT & SISTERS is: $inc</h3>"
