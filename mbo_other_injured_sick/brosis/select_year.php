...
$sql = "SELECT * FROM mbo_other_injured_sick_brosis WHERE (Date_of_Medical_Board_Out LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick_brosis WHERE (`Date_of_Medical_Board_Out` LIKE '$yr%')";
