...
echo "<center><h2>ALL MEDICAL BOARD OUT OTHER INJURED/SICK TILL TO $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_other_injured_sick WHERE (Date_of_Medical_Board_Out BETWEEN '0000-00-00' AND '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick WHERE (Date_of_Medical_Board_Out BETWEEN '0000-00-00' AND '$yr%')";
...
echo "<h3>Total Count of MEDICAL BOARD OUT-OTHER INJURED/SICK TILL TO $yr is: $inc</h3>"
