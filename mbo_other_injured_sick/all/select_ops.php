...
echo "<center><h2>ALL OTHER INJURED/SICK MEDICAL BOARD OUT OF $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_other_injured_sick WHERE (	`Operational/Non_Operational_Areas` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick WHERE (	`Operational/Non_Operational_Areas` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$counter=$counter-1;
echo "<h3>Total OTHER INJURED/SICK MEDICAL BOARD OUT Count of $yr is: $counter</h3>"
