...
echo "<center><h2>ALL INJURED/SICK MEDICAL BOARD OUT OF $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_other_injured_sick WHERE (	`Attributed/Not_Attributed_to_Military_Service` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick WHERE (	`Attributed/Not_Attributed_to_Military_Service` LIKE '$yr%')";
...
echo "<h3>Total OTHER INJURED/SICK MEDICAL BOARD OUT Count of $yr is: $inc</h3>"
