...
$sql = "SELECT * FROM mbo_other_injured_sick_spouse WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick_spouse WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of OTHER INJURED/SICK MEDICAL BOARD OUT SPOUSES is: $inc</h3>"
