...
<body>
<h1 align="center">ALL OTHER INJURED/SICK MEDICAL BOARD OUT  SOLDIER'S PARENTS</h1>
<?php
...
$sql = "SELECT * FROM mbo_other_injured_sick_parents ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM mbo_other_injured_sick_parents ";
...
?> 
<h3>Total OTHER INJURED/SICK MEDICAL BOARD OUT  Parents Count is:<?php echo $inc?></h3>
