...
$sql = "SELECT * FROM mbo_other_injured_sick_parents WHERE (`Current/Last_Unit` LIKE '$uni%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_other_injured_sick_parents WHERE (`Current/Last_Unit` LIKE '$uni%')";
