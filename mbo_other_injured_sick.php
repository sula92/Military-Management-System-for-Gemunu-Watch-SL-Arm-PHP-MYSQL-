...
include('image.php');
	...
	if(isset($_POST['btnSearch'])){
		...
		$sql = "SELECT * FROM mbo_other_injured_sick WHERE Regiment_No='$_POST[txtregno]'";
	...
	if(isset($_POST['btnDelete'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick WHERE Regiment_No='$_POST[txtregno]' || Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		mysqli_set_charset($conn,"utf8");
		$sql = "INSERT INTO dambo_other_injured_sick VALUES('$_POST[txtfino]','$_POST[txtregnum]','$_POST[txtrank]','$_POST[rsen]','$_POST[txtnm]','$_POST[txtfnm]','$_POST[txtrecno]','$_POST[txtaid]','$_POST[txtfor]','$_POST[txtcu]','$_POST[txtpru]','$_POST[txtcsl]','$_POST[txtapp]','$_POST[txtdoj]','$_POST[txtplrc]','$_POST[txtstdc]','$_POST[txtedc]','$_POST[nic]','$_POST[dob]','$_POST[pob]','$_POST[txtbcn]','$_POST[hei]','$_POST[wei]','$_POST[che]','$_POST[txteyc]','$_POST[hac]','$_POST[skc]','$_POST[mark]','$_POST[blg]','$_POST[cis]','$_POST[rel]','$_POST[eth]','$_POST[nosp]','$_POST[noch]','$_POST[nobs]','$_POST[lod]','$_POST[bnk]','$_POST[txtbra]','$_POST[accno]','$_POST[txtacn]',
		

		
'$_POST[txtrfd]','$_POST[dode]','$_POST[txtardo]','$_POST[txtprn]','$_POST[txtdchi]','$_POST[isda]','$_POST[dcno]','$_POST[coin]','$_POST[adeci]',	
		
		'$_POST[abda]','$_POST[abti]','$_POST[txtrfm]','$_POST[doi]','$_POST[txtario]','$_POST[opsar]','$_POST[ams]','$_POST[noin]','$_POST[perc]','$_POST[cldi]','$_POST[txtdci]','$_POST[isd]','$_POST[cno]','$_POST[cnto]','$_POST[coi]','$_POST[deci]','$_POST[noki]','$_POST[txthadd]','$_POST[city]','$_POST[dis]','$_POST[pro]','$_POST[dsag]','$_POST[elect]','$_POST[gnd]','$_POST[nac]','$_POST[nps]','$_POST[mob]','$_POST[hpp]','$_POST[altc]','$_POST[txtemai]','$_POST[msal]','$_POST[whom]','$_POST[fwhe]','$_POST[hola]','$_POST[txthladd]','$_POST[abf]','$_POST[mondi]','$_POST[welf]','$_POST[dowp]','$_POST[hadd]','$_POST[comp]','$_POST[compd]','$_POST[amou]','$_POST[lfa]','$_POST[tta]','$_POST[ratp]')";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
//Check the Button
	if(isset($_POST['btntra'])){
		...
		//Create the Query(Insert Record)
		$sql = "DELETE FROM mbo_other_injured_sick WHERE Regiment_No='$_POST[txtregnum]'";
		//Read the Command
		if(mysqli_query($conn,$sql)){
			//Display Message
    		echo '<script language="javascript">';
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="mbo_other_injured_sick.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left w3-black" style="width:200px; margin-top:-0.4%" id="mySidebar">
  ...
  <a href="#per" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">PERSONAL INFORMATION</a>
   <a href="#mbo" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">MEDICAL BOARD OUT INFORMATION</a>
  <a href="#other_injured_sick" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">OTHER INJURED/SICK-MEDICAL BOARD OUT INFORMATION</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="mbo_other_injured_sick/all/allmbo_other_injured_sick.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER INJURED/SICK-MEDICAL BOARD OUT</center></a></center>
 
<center> <a href="mbo_other_injured_sick/all/per.php" class="w3-bar-item w3-button" style="color:white"><center>ALL NEEDED PERSONAL DETAILS OF A SOLDIER</center></a></center>

<center><a href="mbo_other_injured_sick/all/ams.php" class="w3-bar-item w3-button" style="color:white"><center>AMS / NOT AMS</center></a>

<center><a href="mbo_other_injured_sick/all/ops.php" class="w3-bar-item w3-button" style="color:white"><center>OPERATIONAL/ NON OPERATIONAL AREAS</center></a>


  <center><a href="mbo_other_injured_sick/all/unit.php" class="w3-bar-item w3-button" style="color:white"><center>UNIT WISE</center></a>

 
 <center> <a href="mbo_other_injured_sick/all/year.php" class="w3-bar-item w3-button" style="color:white"><center>YEAR WISE</center></a></center>
 
  <center> <a href="mbo_other_injured_sick/all/period.php" class="w3-bar-item w3-button" style="color:white"><center>PERIOD WISE</center></a></center>
 
  <center> <a href="mbo_other_injured_sick/all/province.php" class="w3-bar-item w3-button" style="color:white"><center>PROVINCIAL WISE</center></a></center>
       
    
   
  <center> <a href="mbo_other_injured_sick/all/married_unmarried.php" class="w3-bar-item w3-button" style="color:white"><center>MARRIED / UNMARRIED  WISE</center></a></center>
  
   <center> <a href="mbo_other_injured_sick/all/comp_notcomp.php" class="w3-bar-item w3-button" style="color:white"><center>COMPENSATED / NOT COMPENSATED WISE</center></a></center>
    
   
 <center> <a href="mbo_other_injured_sick/all/officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
 
  <center><a href="mbo_other_injured_sick/all/rank.php" class="w3-bar-item w3-button" style="color:white"><center>RANK WISE</center></a>
</div>
...
<div class="w3-teal">
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
      <h1 style="margin-left:18%">OTHER INJURED/SICK-MEDICAL BOARD</h1></center>
  </div>
</div>
...
<div class="row" id="other_injured_sick">
      <div class="col-25">
...
<fieldset id="mbo_other_injured_sick"><legend style="color:red">PREVIOUS CATEGORY INFORMATION (OTHER INJURED/SICK-MEDICAL BOARD OUT)</legend>
 ...
 <div class="row">
    ...
    <div class="row">
     ...
     <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="noin" name="noin" placeholder="තුවාල ස්වභාවය" style="width:100%" value="<?php echo $noin; ?>" />
      </div>
    </div>
...
<div class="w3-container" style="height:100px"></div>
 ...
 <center><h1 class="w3-red">TRANFER TO OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT</h1></center>
 
           


<fieldset id="kia"><legend style="color:red">TRANSFER TO DEATH AFTER MEDICAL BOARD OUT</legend>

<div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Reason For DEATH (හේතුව)</label>
      </div>
      <div class="col-75">
        <input type="text" id="rfd" name="txtrfd" value="">
...
<div class="row">
      <div class="col-25">
        <label for="lname" size="40" style="color:white">Date of Death (සිදුවීම් දිනය)</label>
      </div>
      <div class="col-75">
        <input type="date" name="dode" max="2050-01-02"  min="1948-01-02" value="" />
      </div>
    </div>
 <div class="row">
      <div class="col-25">
         <label for="fname" style="color:white">Area that Death Occurred<br>(සිද්ධිය සිදුවූ ප්රදේශය)</label>
      </div>
      <div class="col-75">
        <input type="text" id="txtardo" name="txtardo" value="" placeholder="සිද්ධිය සිදුවූ ප්රදේශය">
     </div>
    </div>
 <div class="row">
      <div class="col-25">
        <label for="fname" style="color:white">Police Report Number<br>(පොලිස් වාර්තා අංකය)</label>
      </div>
      <div class="col-75">
        <input type="text" id="prn" name="txtprn" placeholder="පොලිස් වාර්තා අංකය..." style="width:100%" value="" />
      </div>
    </div>
 ...
 <div class="row">
      <div class="col-25">
        <label for="lname" style="color:white">Death Certificate has Issued<br>(මරණ සහතිකයක් නිකුත් කර තිබේද?)</label>
      </div>
      <div class="col-75">
...
<div class="row">
      <div class="col-25">
        <label for="lname" size="40" style="color:white">Issued Date (නිකුත් කළ දිනය)</label><br>
      </div>
      <div class="col-75">
        <input type="date" name="isda" "2050-01-02"  min="1948-01-02" value="" />
      </div>
    </div>
<div class="row">
      <div class="col-25">
        <label for="fname" style="color:white">Death Certificate No<br>(මරණ සහතික අංකය)</label>
      </div>
      <div class="col-75">
        <input type="text" id="dcno" name="dcno" placeholder="මරණ සහතික අංකය.." style="width:100%" value="" />
      </div>
    </div>
 ...
 <input type="submit" onclick='return confirm_tra(this);' class="w3-left w3-blue" name="btntra" value="Tranfer To OTHER INJURED/SICK-DAMBO" /> 
