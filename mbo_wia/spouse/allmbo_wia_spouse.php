...
<body>
<h1 align="center">ALL WIA MEDICAL BOARD OUT SPOUSES</h1>
<?php
...
$sql = "SELECT * FROM mbo_wia_spouse ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM mbo_wia_spouse ";
