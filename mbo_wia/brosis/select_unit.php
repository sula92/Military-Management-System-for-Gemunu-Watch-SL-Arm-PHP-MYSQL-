...
echo "<center><h2>ALL WIA MEDICAL BOARD OUT BROTHERS & SISTERS IN $uni</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_wia_brosis WHERE (`Current/Last_Unit` LIKE '$uni%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_wia_brosis WHERE (`Current/Last_Unit` LIKE '$uni%')";
...
echo "<h3>Total Count of WIA MEDICAL BOARD OUT BROTHERS & SISTERS From $uni is: $inc</h3>"
?> 
