...
$sql = "SELECT * FROM mbo_wia_brosis WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_wia_brosis WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of WIA MEDICAL BOARD OUT & SISTERS is: $inc</h3>"
