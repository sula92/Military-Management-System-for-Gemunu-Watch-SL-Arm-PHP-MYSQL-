...
echo "<center><h2>ALL WIA MEDICAL BOARD OUT BROTHERS & SISTERSS $x</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_wia WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_wia_brosis WHERE (Regiment_No LIKE '$yr%')";
...
echo "<h3>Total Count of WIA MEDICAL BOARD OUT  BROTHERS & SISTERS $x is: $inc</h3>"
