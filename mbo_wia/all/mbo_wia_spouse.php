...
$sql = "SELECT * FROM mbo_wia_spouse WHERE (NIC_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card w3-border-top  w3-border-bottom">
    ...
    <a href="http://localhost/gw/mbo_wia_spouse.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">SPOUSES</a>
  
    <a href="http://localhost/gw/mbo_wia_children.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CHILDREN</a>
    <a href="http://localhost/gw/mbo_wia_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BROTHERS/SISTERS</a>
    
   <a href="http://localhost/gw/mbo_wia_parents.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">PARENTS</a>
...
<div id="navDemo" class="w3-bar-block w3-panel w3-border-top w3-border-bottom w3-black w3-hide w3-hide-large w3-hide-medium w3-top " style="margin-top:46px">
  ...
  <a href="http://localhost/gw/mbo_wia_spouse.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">SPOUSES</a>
  <a href="file:///C|/xampp/htdocs/gw/mbo_wia_children.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CHILDREN</a>
  <a href="#" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">BROTHERS/SISTERS</a>
  <a href="file:///C|/xampp/htdocs/gw/mbo_wia_parents.php class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">PARENTS</a>
</div>
...
<div class="w3-sidebar w3-bar-block w3-dark-grey w3-card w3-animate-right" style="display:none;right:0; width:30%; " id="rightMenu">
 ...
 <center> <a href="allmbo_wia.php" class="w3-bar-item w3-button" style="color:white"><center>ALL mbo_wia</center></a></center>
 ...
 <center> <a href="officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>WIA-MEDICLA BOAD OUT SPOUSES : <?php echo $sfnm; ?></b></h1>
    <div class="w3-section w3-bottombar w3-padding-16">
      ...
      <a href="http://localhost/gw/mbo_wia/all/per.php"><button class="w3-button w3-white w3-hide-small"><i class="fa fa-photo w3-margin-right"></i>BACK</button></a>
      <a  href="http://localhost/gw/mbo_wia.php"><button class="w3-button w3-white w3-hide-small"><i class="fa fa-map-pin w3-margin-right"></i>BACK TO WIA-MEDICAL BOARD OUT</button></a>
    </div>
    </div>
  </header>
