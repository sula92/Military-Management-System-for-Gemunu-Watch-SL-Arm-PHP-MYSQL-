...
$sql = "SELECT * FROM mbo_wia WHERE (Province LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_wia WHERE (Province LIKE '$yr%')";
...
echo "<h3>Total WIA MEDICAL BOARD OUT Count In $yr is: $inc</h3>"
