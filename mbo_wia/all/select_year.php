...
echo "<center><h2>ALL WIA MEDICAL BOARD OUT IN $yr</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_wia WHERE (Date_of_Incident LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_wia WHERE (`Date_of_Incident` LIKE '$yr%')";
...
echo "<h3>Total Count of WIA MEDICAL BOARD OUT In $yr is: $inc</h3>"
