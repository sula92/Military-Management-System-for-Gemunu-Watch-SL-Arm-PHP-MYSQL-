...
echo "<center><h2>ALL $u WIA MEDICAL BOARD OUT</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_wia WHERE (Civil_Status LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_wia WHERE (Civil_Status LIKE '$yr%')";
...
echo "<h3>TOTAL $u WIA MEDICAL BOARD OUT COUNT IS: $inc</h3>"
