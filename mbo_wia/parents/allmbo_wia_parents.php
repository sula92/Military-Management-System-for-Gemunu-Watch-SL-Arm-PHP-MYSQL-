...
<body>
<h1 align="center">ALL WIA MEDICAL BOARD OUT  SOLDIER'S PARENTS</h1>
<?php
...
$sql = "SELECT * FROM mbo_wia_parents ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM mbo_wia_parents ";
...
?> 
<h3>Total WIA MEDICAL BOARD OUT  Parents Count is:<?php echo $inc?></h3>
