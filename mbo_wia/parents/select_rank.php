...
echo "<center><h2>ALL THE $ran of WIA MEDICAL BOARD OUT PARENTS</center></h2>";

mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM mbo_wia_parents WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM mbo_wia_parents WHERE (`Rank` LIKE '$ran%')";
...
echo "<h3>Total $ran Count of WIA MEDICAL BOARD OUT PARENTS is: $inc</h3>"
