...
$sql = "SELECT * FROM dambo_other_injured_sick_spouse WHERE (`Date_of_Medical_Board_Out` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_other_injured_sick_spouse WHERE (`Date_of_Medical_Board_Out` LIKE '$yr%')";
...
echo "<h3>Total Count of OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT SPOUSES In $yr is: $inc</h3>"
