...
<body>
<h1 align="center">ALL OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT SPOUSES</h1>
<?php
...
$sql = "SELECT * FROM dambo_other_injured_sick_spouse ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM dambo_other_injured_sick_spouse ";
