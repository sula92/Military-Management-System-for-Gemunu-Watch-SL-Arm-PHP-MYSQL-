...
<body>
<h1 align="center">ALL OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT CHILDREN</h1>
<?php
...
$sql = "SELECT * FROM dambo_other_injured_sick_children ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT COUNT(Regiment_No) FROM dambo_other_injured_sick_children ";
...
?> 
<h3>Total OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT SOLDIER'S Children Count is:<?php echo $inc?></h3>
