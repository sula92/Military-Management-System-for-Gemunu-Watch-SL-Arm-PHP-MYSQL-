...
echo "<center><h2>ALL OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT SOLDIER'S CHILDREN IN $uni</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_other_injured_sick_children WHERE (`Current/Last_Unit` LIKE '$uni%') ORDER BY Rank_Seniority_Order";
...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_other_injured_sick_children WHERE (`Current/Last_Unit` LIKE '$uni%')";
...
echo "<h3>Total Count of OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT SOLDIER'S CHILDREN From $uni is: $inc</h3>"
?> 
