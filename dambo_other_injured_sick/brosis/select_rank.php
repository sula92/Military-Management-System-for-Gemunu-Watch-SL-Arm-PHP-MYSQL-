...
$sql = "SELECT * FROM dambo_other_injured_sick_brosis WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
echo "<h3>Total $ran Count of OTHER INJURED/SICKDEATH AFTER MEDICAL BOARD OUT & SISTERS is: $inc</h3>"
