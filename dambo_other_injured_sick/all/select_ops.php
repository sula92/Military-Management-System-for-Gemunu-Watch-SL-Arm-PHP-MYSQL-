...
$conn = new mysqli($servername, $username, $password,$dbname);
		...
		$qry="SELECT count(*) as c FROM dambo_other_injured_sick WHERE (	`Operational/Non_Operational_Areas` LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
$counter=$counter-1;
echo "<h3>Total OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT Count of $yr is: $counter</h3>"
