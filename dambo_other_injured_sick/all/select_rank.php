...
echo "<center><h2>ALL THE $ran of OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT</center></h2>";

mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_other_injured_sick 
 WHERE (Rank LIKE '$ran%') ORDER BY Rank_Seniority_Order";
...
echo "<h3>Total $ran Count of OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT is: $inc</h3>"
