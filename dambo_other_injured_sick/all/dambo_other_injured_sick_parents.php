...
$sql = "SELECT * FROM dambo_other_injured_sick_parents WHERE (NIC_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
if (mysqli_connect_error())
  ...
  echo "Failed to connect to MySQL: ".mysqli_connect_error();
			...
			$sql = "SELECT * FROM photos_parents where (NIC_Number = '$reg')";
...
while ($documents = mysqli_fetch_array($result)) {
	...
	$imagedisplay =$documents['Image']; 
         ...
         echo "<img src = 'http://localhost/gw/parents_photos/$imagedisplay' style=\" width:54%;\" class=\"w3-round\"/>";
...
<div class="w3-sidebar w3-bar-block w3-dark-grey w3-card w3-animate-right" style="display:none;right:0; width:30%; " id="rightMenu">
 ...
 <center> <a href="alldambo_other_injured_sick.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER DEATH</center></a></center>
 ...
 <center> <a href="officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>OTHER INJURED/SICK-MEDICAL BOARD OUT PARENTS : <?php echo $sfnm; ?></b></h1>
