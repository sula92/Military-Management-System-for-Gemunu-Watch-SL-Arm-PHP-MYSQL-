...
$sql = "SELECT * FROM dambo_other_injured_sick 
 WHERE (Regiment_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://localhost/gw/dambo_other_injured_sick_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BROTHERS/SISTERS</a>
     ...
     <a href="http://localhost/gw/dambo_other_injured_sick_parents.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">PARENTS</a>
     
    <a href="http://localhost/gw/dambo_other_injured_sick.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">REFRESH PAGE</a>
...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
  ...
  <a href="http://localhost/gw/dambo_other_injured_sick_children.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CHILDREN</a>
...
<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left w3-black" style="width:200px; margin-top:-0.4%" id="mySidebar">
  ...
  <a href="#dambo_other_injured_sick" class="w3-bar-item w3-button w3-panel w3-border w3-border-red">OTHER INJURED/SICK INFORMATION</a>
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0; width:30%; background-color:black" id="rightMenu">
 ...
 <center> <a href="alldambo_other_injured_sick.php" class="w3-bar-item w3-button" style="color:white"><center>ALL OTHER INJURED/SICK MEDICAL BOARD OUT</center></a></center>
...
<div class="w3-teal">
 <button class="w3-button w3-teal w3-xlarge w3-hide-large" onclick="w3_open()">&#9776;</button>
  ...
  <button class="w3-button w3-teal w3-xlarge w3-right" id="rep" onclick="openRightMenu()">REPORTS&#9776;
    ...
    <center>
      <h1>OTHER INJURED/SICK-MEDICAL BOARD OUT</h1></center>
  </div>
</div>
...
<div class="row">
 ...
 <div class="row">
    ...
    <div class="row">
      <div class="col-25">
        <label for="lname" style="color:blue">Operational/<br>Non Operational Areas<br>(මෙහෙයුම්/මෙහෙයුම් නොවන ප්රදේශ)</label>
      </div>
      <div class="col-75">
     ...
     <div class="row">
      <div class="col-25">
        <label for="lname" style="color:blue">Attributed/<br>Not Attributed to Military Service<br>(යුද හමුදා සේවයට අයත් වේ/නොවේ)</label>
      </div>
      <div class="col-75">
