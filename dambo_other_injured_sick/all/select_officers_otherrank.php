...
$sql = "SELECT * FROM dambo_other_injured_sick 
 WHERE (Regiment_No LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
echo "<h3>Total Count of OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT $x is: $inc</h3>"
