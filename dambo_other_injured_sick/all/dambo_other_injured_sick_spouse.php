...
$sql = "SELECT * FROM dambo_other_injured_sick_spouse WHERE (NIC_No LIKE '$reg%') ORDER BY Rank_Seniority_Order";
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card w3-border-top  w3-border-bottom">
    ...
    <a href="http://localhost/gw/dambo_other_injured_sick_spouse.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">SPOUSES</a>
  
    <a href="http://localhost/gw/dambo_other_injured_sick_children.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CHILDREN</a>
    <a href="http://localhost/gw/dambo_other_injured_sick_brosis.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">BROTHERS/SISTERS</a>
    
   <a href="http://localhost/gw/dambo_other_injured_sick_parents.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">PARENTS</a>
...
<div id="navDemo" class="w3-bar-block w3-panel w3-border-top w3-border-bottom w3-black w3-hide w3-hide-large w3-hide-medium w3-top " style="margin-top:46px">
  ...
  <a href="http://localhost/gw/dambo_other_injured_sick_spouse.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">SPOUSES</a>
  <a href="file:///C|/xampp/htdocs/gw/dambo_other_injured_sick_children.php" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">CHILDREN</a>
  <a href="#" class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">BROTHERS/SISTERS</a>
  <a href="file:///C|/xampp/htdocs/gw/dambo_other_injured_sick_parents.php class="w3-bar-item w3-button w3-padding-large" onclick="myFunction()">PARENTS</a>
</div>
...
if (mysqli_connect_error())
  ...
  echo "Failed to connect to MySQL: ".mysqli_connect_error();
			...
			$sql = "SELECT * FROM photos_spouse where (NIC_Number = '$reg')";
...
while ($documents = mysqli_fetch_array($result)) {
	...
	$imagedisplay =$documents['Image']; 
         ...
         echo "<img src = 'http://localhost/gw/spouses_photos/$imagedisplay' style=\" width:54%;\" class=\"w3-round\"/>";
...
<div class="w3-sidebar w3-bar-block w3-dark-grey w3-card w3-animate-right" style="display:none;right:0; width:30%; " id="rightMenu">
 ...
 <center> <a href="alldambo_other_injured_sick.php" class="w3-bar-item w3-button" style="color:white"><center>ALL dambo_other_injured_sick 
</center></a></center>
 ...
 <center> <a href="officers_otherrank.php" class="w3-bar-item w3-button" style="color:white"><center>OFFICERS / OTHER RANK WISE</center></a></center>
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>OTHER INJURED/SICK-DEATH AFTER MEDICLA BOAD OUT SPOUSES : <?php echo $sfnm; ?></b></h1>
    <div class="w3-section w3-bottombar w3-padding-16">
      
      <button class="w3-button w3-white" onclick="openRightMenu()"><i class="fa fa-diamond w3-margin-right "></i>REPORTS</button>
      <a href="http://localhost/gw/dambo_other_injured_sick/all/per.php"><button class="w3-button w3-white w3-hide-small"><i class="fa fa-photo w3-margin-right"></i>BACK</button></a>
      <a  href="http://localhost/gw/dambo_other_injured_sick.php"><button class="w3-button w3-white w3-hide-small"><i class="fa fa-map-pin w3-margin-right"></i>BACK TO OTHER INJURED/SICK-DAMBO</button></a>
    </div>
    </div>
  </header>
...
<form class="w3-container">
        ...
        <div class="row">
       	  ...
       	  <div class="ld">File No (ලිපිගොනු අංකය)</div>
                <div class="rd"><input class="w3-input" type="text"  name="txtfino" maxlength="50" placeholder="ලිපිගොනු අංකය" value="<?php echo $fino; ?>" /></div>
          </div>
             <div class="row">
      ...
      <option value="FIELD MARSHAL(ෆීල්ඩ් මාර්ෂල්)">FIELD MARSHAL(ෆීල්ඩ් මාර්ෂල්)</option>
             ...
             <div class="row">
                ...
                <div class="rd">
                <select class="w3-select" name="rsen">
      ...
      <option value="01">01-FIELD MARSHAL(ෆීල්ඩ් මාර්ෂල්)</option>
          ...
          <div class="row">
                ...
                <div class="rd">
                <select class="w3-select" name="txtcu">
            ...
            <div class="row"></div>
    <fieldset ><legend style="color:red">SPOUSE'S PERSONAL DETAILS (පුද්ගලික විස්තර)</legend>  
           <div class="row">
            <div class="ld">
...
<div class="row">
  ...
  <div class="w3-black w3-center w3-padding-24">SID</div>
