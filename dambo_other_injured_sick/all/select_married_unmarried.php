...
echo "<center><h2>ALL $u OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT</center></h2>";
mysqli_set_charset($conn,"utf8");
$sql = "SELECT * FROM dambo_other_injured_sick 
 WHERE (Civil_Status LIKE '$yr%') ORDER BY Rank_Seniority_Order";
...
echo "<h3>TOTAL $u OTHER INJURED/SICK DEATH AFTER MEDICAL BOARD OUT COUNT IS: $inc</h3>"
